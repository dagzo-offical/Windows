...
function LessonL01(){
  ...
  return React.createElement("section",null,
    ...
    React.createElement(H2,{num:"§1",id:"toc-L1-1"},t(lang,"Kali Linux nima?","What is Kali Linux?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L1-2"},t(lang,"Nega aynan Kali?","Why Kali?")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L1-3"},t(lang,"Interaktiv simulyator: bir xil vazifa, ikki muhit","Interactive simulator: same task, two environments")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L1-4"},t(lang,"Kali va boshqa distributivlar","Kali vs other distros")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L1-5"},t(lang,"Kali'ning turli nashrlari","Kali's editions")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L1-6"},t(lang,"Versiyani tekshirish","Checking the version")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L1-7"},t(lang,"Pentest bosqichlari va Kali menyusi","Pentest phases and the Kali menu")),
    ...
    React.createElement(H2,{num:"§8",id:"toc-L1-8"},t(lang,"Amaliyot: versiyani aniqlash","Practice: identify the version")),
...
function LessonL11(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L11-1"},t(lang,"Nmap nima?","What is Nmap?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L11-2"},t(lang,"Skan qanday ishlaydi","How a scan works")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L11-3"},t(lang,"Skan turlari va ular orasidagi tanlov","Scan types and the tradeoffs")),
    React.createElement(LayerStack,{layers:[
    ...
    React.createElement(H2,{num:"§4",id:"toc-L11-4"},t(lang,"Interaktiv simulyator: kim sizni sezadi?","Interactive simulator: who notices you?")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L11-5"},t(lang,"Tezlik shablonlari (timing)","Timing templates")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L11-6"},t(lang,"NSE skriptlar va chiqish formatlari","NSE scripts and output formats")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L11-7"},t(lang,"Skan turlarini solishtirish","Comparing scan types")),
    ...
    React.createElement(H2,{num:"§8",id:"toc-L11-8"},t(lang,"Amaliyot: xizmatlarni aniqlash","Practice: service detection")),
...
function LessonL21(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L21-1"},t(lang,"Metasploit nima?","What is Metasploit?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L21-2"},t(lang,"Ekspluatatsiya oqimi","The exploitation flow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L21-3"},t(lang,"Modul turlari","Module types")),
    React.createElement(LayerStack,{layers:[
    ...
    React.createElement(H2,{num:"§4",id:"toc-L21-4"},t(lang,"Sessiya, shell va Meterpreter","Sessions, shells and Meterpreter")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L21-5"},t(lang,"Ma'lumotlar bazasi va ish maydoni","Database and workspaces")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L21-6"},t(lang,"Bind va reverse shell","Bind vs reverse shell")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L21-7"},t(lang,"Interaktiv simulyator: nega reverse shell ishlaydi?","Interactive simulator: why does a reverse shell work?")),
    ...
    React.createElement(H2,{num:"§8",id:"toc-L21-8"},t(lang,"Amaliyot: msfconsole ish oqimi","Practice: the msfconsole workflow")),
...
function LiveDot({color="var(--accent)"}){
  return React.createElement("span",{style:{width:7,height:7,borderRadius:"50%",background:color,boxShadow:`0 0 8px ${color}, 0 0 0 0 ${color}66`,animation:"pulse-ring 1.4s ease-out infinite",display:"inline-block",flexShrink:0}});
}
function NavLink({label,sub,active,onClick}){
  return React.createElement("a",{href:"#",onClick:e=>{e.preventDefault();onClick();},style:{display:"flex",flexDirection:"column",textAlign:"center",padding:"7px 13px",borderRadius:8,textDecoration:"none",background:active?"var(--accent-soft)":"transparent",color:active?"var(--accent)":"var(--text-1)",border:`1px solid ${active?"var(--accent-border)":"transparent"}`,transition:"all 200ms",lineHeight:1.1}},
    React.createElement("span",{style:{fontSize:12.5,fontWeight:500}},label),
    React.createElement("span",{style:{fontFamily:"var(--font-mono)",fontSize:8.5,opacity:.55,letterSpacing:"0.1em",textTransform:"uppercase"}},sub));
}
function TopNav({setRoute,user,routeName,onOpenProfile,onOpenAI,setLang}){
  const lang=useLang();
  ...
  return React.createElement("nav",{style:{position:"sticky",top:0,zIndex:100,height:60,background:"rgba(4,6,13,0.92)",backdropFilter:"blur(12px)",borderBottom:"1px solid var(--border)",display:"flex",alignItems:"center",padding:"0 24px",gap:12}},
    React.createElement("button",{onClick:()=>setRoute("landing"),style:{appearance:"none",background:"none",border:"none",cursor:"pointer",display:"flex",alignItems:"center",gap:8,color:"var(--accent)",fontFamily:"var(--font-mono)",fontSize:11,fontWeight:700,letterSpacing:1,padding:0}},
      React.createElement(Icon,{name:"terminal",size:16}),
      "KALI ACADEMY"
    ),
    React.createElement("div",{style:{display:"flex",gap:4,marginLeft:10}},
      React.createElement(NavLink,{label:t(lang,"Boshqaruv","Dashboard"),sub:"DASHBOARD",active:routeName==="dashboard",onClick:()=>setRoute("dashboard")}),
      React.createElement(NavLink,{label:t(lang,"Kurslar","Courses"),sub:"COURSES",active:routeName==="section",onClick:()=>setRoute({name:"section",sec:1})})),
    React.createElement("div",{style:{flex:1}}),
    ...
    user&&React.createElement("div",{onClick:onOpenProfile,style:{display:"flex",alignItems:"center",gap:9,padding:"4px 12px 4px 4px",borderRadius:999,background:"var(--surface)",border:"1px solid var(--border)",cursor:"pointer"}},
      React.createElement("div",{style:{position:"relative",flexShrink:0}},
        React.createElement("div",{style:{width:26,height:26,borderRadius:"50%",background:"linear-gradient(135deg,var(--accent),#c084fc,#00d4ff)",padding:1.5,boxShadow:"0 0 8px var(--accent-glow)"}},
          React.createElement("div",{style:{width:"100%",height:"100%",borderRadius:"50%",background:"#0a0a12",display:"grid",placeItems:"center"}},
            React.createElement("span",{style:{background:"linear-gradient(135deg,var(--accent),#c084fc)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontSize:9,fontWeight:900,fontFamily:"var(--font-mono)"}},(user.name||"Student").slice(0,2).toUpperCase()))),
        React.createElement("div",{style:{position:"absolute",bottom:0,right:0,width:7,height:7,borderRadius:"50%",background:"var(--accent)",border:"1.5px solid #0a0a12"}})),
      React.createElement("div",{style:{display:"flex",flexDirection:"column",lineHeight:1.1}},
        React.createElement("span",{style:{fontSize:11.5,fontWeight:600,color:"var(--text-0)"}},user.name||"Student"),
        React.createElement("span",{style:{fontFamily:"var(--font-mono)",fontSize:9.5,color:"var(--accent)"}},`LVL ${lvl} · ${user.xp||0} XP`))),
...
function LandingScreen({setRoute}){
  const lang=useLang();
  const stats=[
    {n:"38",uz:"Dars",en:"Lessons"},
    {n:"4",uz:"Bo'lim",en:"Sections"},
    {n:"64",uz:"Slayd",en:"Slides"},
    {n:"AI",uz:"Yordamchi",en:"Assistant"}
  ];
  return React.createElement("section",{style:{position:"relative",padding:"48px 28px 40px",maxWidth:1100,margin:"0 auto"}},
    React.createElement("div",{style:{display:"grid",gridTemplateColumns:"1.15fr 1fr",gap:40,alignItems:"center"}},
      React.createElement("div",{className:"fade-up"},
        React.createElement("div",{className:"eyebrow",style:{display:"flex",alignItems:"center",gap:10,marginBottom:16}},
          React.createElement(LiveDot,null),
          React.createElement("span",null,"SECTOR_04 // PRIVILEGE_ESCALATION_TRAINING")),
        React.createElement("h1",{className:"display",style:{fontSize:"clamp(32px,4.6vw,56px)",lineHeight:1.06,margin:0,letterSpacing:"-0.03em",fontWeight:600,color:"var(--text-0)"}},
          lang==="en"
            ?React.createElement(React.Fragment,null,"The first academy that",React.createElement("br",null),"truly teaches ",React.createElement("span",{style:{background:"linear-gradient(90deg,var(--accent),#c084fc)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}},"Kali Linux"),".")
            :React.createElement(React.Fragment,null,"Kali Linux'ni",React.createElement("br",null),React.createElement("span",{style:{background:"linear-gradient(90deg,var(--accent),#c084fc)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}},"chuqur egallash"),"ning ilk akademiyasi.")),
        React.createElement("p",{style:{marginTop:18,fontSize:15,lineHeight:1.7,color:"var(--text-1)",maxWidth:520}},
          t(lang,
        ...
        React.createElement("div",{style:{display:"flex",gap:12,marginTop:28,flexWrap:"wrap"}},
          React.createElement("button",{className:"btn btn-primary",onClick:()=>setRoute("dashboard")},t(lang,"Boshlash →","Start →")),
          React.createElement("a",{className:"btn",href:"../index.html",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"}},"← CyberSecurity")),
        React.createElement("div",{style:{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:18,marginTop:40,paddingTop:26,borderTop:"1px solid var(--border)"}},
          stats.map((s,i)=>React.createElement("div",{key:i,className:"stat fade-up",style:{animationDelay:`${0.1+i*0.08}s`}},
            React.createElement("div",{className:"stat-n"},s.n),
            React.createElement("div",{className:"stat-l"},t(lang,s.uz,s.en)))))),
      React.createElement(HeroVisual,null)));
}
function HeroVisual(){
  const lang=useLang();
  const orbitIcons=["lock","key","shield","bug","database","network","code","target"];
  const orbitColors=["var(--c-attack)","var(--c-auth)","var(--accent)","var(--c-attack)","var(--c-system)","var(--c-user)","var(--c-system)","var(--accent-2)"];
  return React.createElement("div",{style:{position:"relative",aspectRatio:"1",maxWidth:420,margin:"0 auto"}},
    React.createElement("svg",{viewBox:"0 0 400 400",style:{width:"100%",height:"100%"}},
      React.createElement("defs",null,
        React.createElement("radialGradient",{id:"core-grad-ka",cx:"50%",cy:"50%",r:"50%"},
          React.createElement("stop",{offset:"0%",stopColor:"var(--accent)",stopOpacity:"0.8"}),
          React.createElement("stop",{offset:"100%",stopColor:"var(--accent)",stopOpacity:"0"})),
        React.createElement("filter",{id:"hero-glow-ka",x:"-50%",y:"-50%",width:"200%",height:"200%"},
      ...
      [180,140,100].map((r,i)=>React.createElement("circle",{key:i,cx:200,cy:200,r,fill:"none",stroke:"var(--accent)",strokeOpacity:0.15-i*0.03,strokeWidth:1,strokeDasharray:"4 6",style:{transformOrigin:"200px 200px",animation:`spin-slow ${30+i*10}s linear infinite ${i%2?"reverse":"normal"}`}})),
      React.createElement("circle",{cx:200,cy:200,r:80,fill:"url(#core-grad-ka)"}),
      React.createElement("circle",{cx:200,cy:200,r:42,fill:"var(--bg-2)",stroke:"var(--accent)",strokeWidth:2,filter:"url(#hero-glow-ka)"}),
      React.createElement("g",{transform:"translate(180,180)",fill:"var(--accent)"},
        React.createElement("rect",{x:0,y:0,width:18,height:18,rx:2}),
        React.createElement("rect",{x:22,y:0,width:18,height:18,rx:2}),
        React.createElement("rect",{x:0,y:22,width:18,height:18,rx:2}),
        React.createElement("rect",{x:22,y:22,width:18,height:18,rx:2})),
      React.createElement("g",{style:{transformOrigin:"200px 200px",animation:"spin-slow 24s linear infinite"}},
        orbitIcons.map((ic,i)=>{
          const ang=(i/8)*Math.PI*2;
          const rad=i%2?140:180;
          const x=200+Math.cos(ang)*rad;
          const y=200+Math.sin(ang)*rad;
          return React.createElement("g",{key:i,style:{transformOrigin:`${x}px ${y}px`,animation:"spin-slow 24s linear infinite reverse"}},
            React.createElement("circle",{cx:x,cy:y,r:20,fill:"var(--bg-2)",stroke:orbitColors[i],strokeWidth:1.5}),
            React.createElement("foreignObject",{x:x-10,y:y-10,width:20,height:20,style:{color:orbitColors[i]}},
              React.createElement(Icon,{name:ic,size:20})));
        })),
      [0,1,2,3].map(i=>{
        const ang=(i/4)*Math.PI*2;
        return React.createElement("line",{key:i,x1:200,y1:200,x2:200+Math.cos(ang)*180,y2:200+Math.sin(ang)*180,stroke:"var(--accent)",strokeOpacity:0.2,strokeWidth:1,strokeDasharray:"2 6"});
      })),
    React.createElement("div",{style:{position:"absolute",top:"5%",left:"-5%",background:"var(--surface)",border:"1px solid var(--accent-border)",borderRadius:8,padding:"8px 12px",fontFamily:"var(--font-mono)",fontSize:11,color:"var(--accent)",backdropFilter:"blur(10px)",display:"flex",alignItems:"center",gap:6}},
      React.createElement(LiveDot,null),t(lang,"Nmap · skanerlanmoqda","Nmap · scanning")),
    React.createElement("div",{style:{position:"absolute",bottom:"12%",right:"-5%",background:"var(--surface)",border:"1px solid rgba(255,58,94,0.3)",borderRadius:8,padding:"8px 12px",fontFamily:"var(--font-mono)",fontSize:11,color:"var(--c-attack)",backdropFilter:"blur(10px)",display:"flex",alignItems:"center",gap:6}},
      React.createElement(Icon,{name:"bug",size:11}),t(lang,"Exploit ishga tushdi","Exploit triggered")),
    React.createElement("div",{style:{position:"absolute",top:"45%",right:"-8%",background:"var(--surface)",border:"1px solid rgba(184,140,255,0.3)",borderRadius:8,padding:"8px 12px",fontFamily:"var(--font-mono)",fontSize:11,color:"var(--c-auth)",backdropFilter:"blur(10px)",display:"flex",alignItems:"center",gap:6}},
      React.createElement(Icon,{name:"key",size:11}),t(lang,"Root shell olindi","Root shell obtained")));
}
...
// ── Lesson Screen ─────────────────────────────────────────────
const TOC_SECTIONS={
  1:[{id:"toc-L1-1",uz:"Kali Linux nima?",en:"What is Kali Linux?"},{id:"toc-L1-2",uz:"Nega aynan Kali?",en:"Why Kali?"},{id:"toc-L1-3",uz:"Interaktiv simulyator: bir xil vazifa, ikki muhit",en:"Interactive simulator: same task, two environments"},{id:"toc-L1-4",uz:"Kali va boshqa distributivlar",en:"Kali vs other distros"},{id:"toc-L1-5",uz:"Kali'ning turli nashrlari",en:"Kali's editions"},{id:"toc-L1-6",uz:"Versiyani tekshirish",en:"Checking the version"},{id:"toc-L1-7",uz:"Pentest bosqichlari va Kali menyusi",en:"Pentest phases and the Kali menu"},{id:"toc-L1-8",uz:"Amaliyot: versiyani aniqlash",en:"Practice: identify the version"}],
  2:[{id:"toc-L2-1",uz:"Kali'ni o'rnatish usullari",en:"Ways to install Kali"},{id:"toc-L2-2",uz:"O'rnatish oqimi",en:"The install flow"},{id:"toc-L2-3",uz:"Yuklab olishni tekshirish nima uchun muhim",en:"Why verifying the download matters"},{id:"toc-L2-4",uz:"Interaktiv simulyator: ISO tasdiqlandimi yoki buzilganmi?",en:"Interactive simulator: is the ISO verified or tampered?"},{id:"toc-L2-5",uz:"O'rnatishdan keyingi birinchi qadamlar",en:"First steps after install"},{id:"toc-L2-6",uz:"VM tarmoq rejimlari",en:"VM network modes"},{id:"toc-L2-7",uz:"VM tarmoq rejimlarini solishtirish",en:"Comparing VM network modes"},{id:"toc-L2-8",uz:"Amaliyot: ISO ni tekshirish",en:"Practice: verify the ISO"}],
  3:[{id:"toc-L3-1",uz:"Nega buyruq qatori?",en:"Why the command line?"},{id:"toc-L3-2",uz:"Buyruq toifalari",en:"Command categories"},{id:"toc-L3-3",uz:"Navigatsiya va fayllar chuqurroq",en:"Navigation and files in depth"},{id:"toc-L3-4",uz:"Fayllarni ko'rish",en:"Viewing files"},{id:"toc-L3-5",uz:"Quvur va yo'naltirish",en:"Pipes and redirection"},{id:"toc-L3-6",uz:"Interaktiv simulyator: qo'lda o'qish vs quvur bilan filtrlash",en:"Interactive simulator: reading by hand vs filtering with a pipe"},{id:"toc-L3-7",uz:"Wildcard va yordam",en:"Wildcards and help"},{id:"toc-L3-8",uz:"Quvur qanday oqadi",en:"How a pipe flows"},{id:"toc-L3-9",uz:"Amaliyot: haqiqiy natija",en:"Practice: real output"}],
  4:[{id:"toc-L4-1",uz:"Linux fayl tizimi (FHS)",en:"The Linux file system (FHS)"},{id:"toc-L4-2",uz:"Asosiy kataloglar",en:"The key directories"},{id:"toc-L4-3",uz:"Pentester uchun nega muhim?",en:"Why it matters to a pentester"},{id:"toc-L4-4",uz:"Interaktiv simulyator: oddiy foydalanuvchi vs root",en:"Interactive simulator: regular user vs root"},{id:"toc-L4-5",uz:"Mutlaq va nisbiy yo'llar",en:"Absolute vs relative paths"},{id:"toc-L4-6",uz:"Mutlaq va nisbiy yo'l — solishtirish",en:"Absolute vs relative path — compared"},{id:"toc-L4-7",uz:"Amaliyot: fayl tizimini aylanish",en:"Practice: walking the file system"}],
  5:[{id:"toc-L5-1",uz:"Foydalanuvchilar va guruhlar",en:"Users and groups"},{id:"toc-L5-2",uz:"Ruxsatlarni o'qish (rwx)",en:"Reading permissions (rwx)"},{id:"toc-L5-3",uz:"Sakkizlik (octal) matematika",en:"Octal math"},{id:"toc-L5-4",uz:"chmod, chown va amaliyot",en:"chmod, chown and practice"},{id:"toc-L5-5",uz:"SUID, SGID va sudo",en:"SUID, SGID and sudo"},{id:"toc-L5-6",uz:"Interaktiv simulyator: xavfsiz vs xavfli SUID",en:"Interactive simulator: safe vs risky SUID"},{id:"toc-L5-7",uz:"Sakkizlik va simvolik — ikki usul",en:"Octal vs symbolic — two ways"},{id:"toc-L5-8",uz:"Amaliyot: ruxsatlarni o'qish",en:"Practice: reading permissions"}],
  6:[{id:"toc-L6-1",uz:"apt nima?",en:"What is apt?"},{id:"toc-L6-2",uz:"Paket o'rnatish oqimi",en:"The package-install flow"},{id:"toc-L6-3",uz:"update va upgrade farqi",en:"update vs upgrade"},{id:"toc-L6-4",uz:"Interaktiv simulyator: update'ni tashlab ketsangiz nima bo'ladi?",en:"Interactive simulator: what happens if you skip update?"},{id:"toc-L6-5",uz:"Asosiy buyruqlar",en:"Core commands"},{id:"toc-L6-6",uz:"Omborlar va metapaketlar",en:"Repositories and metapackages"},{id:"toc-L6-7",uz:"apt buyruqlari qatlamma-qatlam",en:"The apt commands, layer by layer"},{id:"toc-L6-8",uz:"Amaliyot: dastur o'rnatish",en:"Practice: installing a tool"}],
  7:[{id:"toc-L7-1",uz:"Nega bash skript?",en:"Why bash scripting?"},{id:"toc-L7-2",uz:"Skript qanday ishlaydi",en:"How a script runs"},{id:"toc-L7-3",uz:"O'zgaruvchilar va qo'shtirnoq",en:"Variables and quoting"},{id:"toc-L7-4",uz:"Shartlar va sikllar",en:"Conditions and loops"},{id:"toc-L7-5",uz:"Amaliy recon skripti",en:"A practical recon script"},{id:"toc-L7-6",uz:"Bash qurilishlari",en:"Bash building blocks"},{id:"toc-L7-7",uz:"Interaktiv simulyator: qo'lda vs skript bilan",en:"Interactive simulator: by hand vs with a script"}],
  8:[{id:"toc-L8-1",uz:"Tarmoq holatini ko'rish",en:"Inspecting the network"},{id:"toc-L8-2",uz:"Foydali buyruqlar",en:"Useful commands"},{id:"toc-L8-3",uz:"ip a chiqishini o'qish",en:"Reading ip a output"},{id:"toc-L8-4",uz:"Interaktiv simulyator: zanjir qayerda uzilgan?",en:"Interactive simulator: where does the chain break?"},{id:"toc-L8-5",uz:"MAC manzilni o'zgartirish",en:"Changing the MAC address"},{id:"toc-L8-6",uz:"Amaliyot: ip a chiqishini o'qish",en:"Practice: reading ip a"}],
  9:[{id:"toc-L9-1",uz:"Xizmatlar va systemd",en:"Services and systemd"},{id:"toc-L9-2",uz:"Xizmat hayot tsikli",en:"The service lifecycle"},{id:"toc-L9-3",uz:"start va enable: qanday farq bor?",en:"start vs enable: what's the difference?"},{id:"toc-L9-4",uz:"Interaktiv simulyator: reboot'dan keyin nima bo'ladi?",en:"Interactive simulator: what happens after a reboot?"},{id:"toc-L9-5",uz:"Pentestda kerak bo'ladigan xizmatlar",en:"Services you'll need in a pentest"},{id:"toc-L9-6",uz:"Loglarni ko'rish",en:"Viewing logs"},{id:"toc-L9-7",uz:"systemctl — qisqacha ma'lumotnoma",en:"systemctl — quick reference"},{id:"toc-L9-8",uz:"Amaliyot: xizmat holati",en:"Practice: service status"}],
  10:[{id:"toc-L10-1",uz:"600+ vosita, tartibli",en:"600+ tools, organized"},{id:"toc-L10-2",uz:"Asosiy toifalar",en:"Main categories"},{id:"toc-L10-3",uz:"Toifalar pentest bosqichlariga mos",en:"Categories map to pentest phases"},{id:"toc-L10-4",uz:"Vositani topish va o'rnatish — asoslar",en:"Finding and installing a tool — the basics"},{id:"toc-L10-5",uz:"Vosita bilan yordam olish",en:"Getting help with a tool"},{id:"toc-L10-6",uz:"Interaktiv simulyator: omborda bormi, yo'qmi?",en:"Interactive simulator: in the repo, or not?"},{id:"toc-L10-7",uz:"Amaliyot: vosita qidirish",en:"Practice: searching for a tool"}],
  11:[{id:"toc-L11-1",uz:"Nmap nima?",en:"What is Nmap?"},{id:"toc-L11-2",uz:"Skan qanday ishlaydi",en:"How a scan works"},{id:"toc-L11-3",uz:"Skan turlari va ular orasidagi tanlov",en:"Scan types and the tradeoffs"},{id:"toc-L11-4",uz:"Interaktiv simulyator: kim sizni sezadi?",en:"Interactive simulator: who notices you?"},{id:"toc-L11-5",uz:"Tezlik shablonlari (timing)",en:"Timing templates"},{id:"toc-L11-6",uz:"NSE skriptlar va chiqish formatlari",en:"NSE scripts and output formats"},{id:"toc-L11-7",uz:"Skan turlarini solishtirish",en:"Comparing scan types"},{id:"toc-L11-8",uz:"Amaliyot: xizmatlarni aniqlash",en:"Practice: service detection"}],
  12:[{id:"toc-L12-1",uz:"Netdiscover nima?",en:"What is Netdiscover?"},{id:"toc-L12-2",uz:"ARP orqali topish",en:"Discovery via ARP"},{id:"toc-L12-3",uz:"Passiv va aktiv rejim",en:"Passive vs active mode"},{id:"toc-L12-4",uz:"Interaktiv simulyator: aktiv vs passiv qanday farq qiladi",en:"Interactive simulator: how active differs from passive"},{id:"toc-L12-5",uz:"Natijani o'qish",en:"Reading the output"},{id:"toc-L12-6",uz:"Netdiscover parametrlari",en:"Netdiscover options"},{id:"toc-L12-7",uz:"Amaliyot: tirik xostlar",en:"Practice: live hosts"}],
  13:[{id:"toc-L13-1",uz:"Masscan nima?",en:"What is Masscan?"},{id:"toc-L13-2",uz:"Masscan + Nmap ish oqimi",en:"The Masscan + Nmap workflow"},{id:"toc-L13-3",uz:"Nima uchun bunchalik tez?",en:"Why so fast?"},{id:"toc-L13-4",uz:"Tezlikni sozlash — ehtiyotkorlik",en:"Tuning the rate — carefully"},{id:"toc-L13-5",uz:"Interaktiv simulyator: ehtiyotkor vs beparvo tezlik",en:"Interactive simulator: careful vs reckless rate"},{id:"toc-L13-6",uz:"Masscan va Nmap — vazifa taqsimoti",en:"Masscan vs Nmap — division of labor"},{id:"toc-L13-7",uz:"Amaliyot: ikki bosqichli ish oqimi",en:"Practice: the two-stage workflow"}],
  14:[{id:"toc-L14-1",uz:"DNS enumeratsiya nima uchun?",en:"Why DNS enumeration?"},{id:"toc-L14-2",uz:"Enumeratsiya oqimi",en:"Enumeration flow"},{id:"toc-L14-3",uz:"DNS yozuv turlari",en:"DNS record types"},{id:"toc-L14-4",uz:"Zona transferi va brute-force",en:"Zone transfer and brute-force"},{id:"toc-L14-5",uz:"Interaktiv simulyator: AXFR ochiq yoki yopiqmi?",en:"Interactive simulator: is AXFR open or restricted?"},{id:"toc-L14-6",uz:"Amaliyot: yozuvlarni so'rash",en:"Practice: querying records"}],
  15:[{id:"toc-L15-1",uz:"theHarvester nima?",en:"What is theHarvester?"},{id:"toc-L15-2",uz:"Passiv razvedka oqimi",en:"Passive recon flow"},{id:"toc-L15-3",uz:"Nega passiv razvedka qimmatli?",en:"Why passive recon is valuable"},{id:"toc-L15-4",uz:"Interaktiv simulyator: oshkor vs gigienik kompaniya",en:"Interactive simulator: exposed vs hygienic company"},{id:"toc-L15-5",uz:"Manbalar va crt.sh",en:"Sources and crt.sh"},{id:"toc-L15-6",uz:"theHarvester manbalari",en:"theHarvester sources"},{id:"toc-L15-7",uz:"Amaliyot: passiv razvedka",en:"Practice: passive recon"}],
  16:[{id:"toc-L16-1",uz:"Nikto nima?",en:"What is Nikto?"},{id:"toc-L16-2",uz:"Skan oqimi",en:"Scan flow"},{id:"toc-L16-3",uz:"Nikto nimalarni topadi?",en:"What Nikto finds"},{id:"toc-L16-4",uz:"Sozlamalar va proksi",en:"Options and proxy"},{id:"toc-L16-5",uz:"Interaktiv simulyator: cheklovsiz skan WAF'ga uchraydi",en:"Interactive simulator: an unfiltered scan meets a WAF"},{id:"toc-L16-6",uz:"Amaliyot: veb-serverni skanerlash",en:"Practice: scanning a web server"}],
  17:[{id:"toc-L17-1",uz:"WhatWeb nima?",en:"What is WhatWeb?"},{id:"toc-L17-2",uz:"Nima aniqlanadi",en:"What it detects"},{id:"toc-L17-3",uz:"U qanday aniqlaydi?",en:"How it detects"},{id:"toc-L17-4",uz:"Agressivlik va keyingi qadam",en:"Aggression and the next step"},{id:"toc-L17-5",uz:"Interaktiv simulyator: -a 1 vs -a 4",en:"Interactive simulator: -a 1 vs -a 4"},{id:"toc-L17-6",uz:"WhatWeb aniqlash oqimi",en:"WhatWeb detection flow"},{id:"toc-L17-7",uz:"Amaliyot: texnologiyalarni aniqlash",en:"Practice: identifying tech"}],
  18:[{id:"toc-L18-1",uz:"enum4linux nima?",en:"What is enum4linux?"},{id:"toc-L18-2",uz:"Enumeratsiya oqimi",en:"Enumeration flow"},{id:"toc-L18-3",uz:"\\\"Null session\\\" nima?",en:"What is a null session?"},{id:"toc-L18-4",uz:"Nima chiqariladi va ng versiya",en:"What it extracts and the ng version"},{id:"toc-L18-5",uz:"Interaktiv simulyator: null session ruxsat etilganmi?",en:"Interactive simulator: is the null session allowed?"},{id:"toc-L18-6",uz:"Amaliyot: SMB enumeratsiyasi",en:"Practice: SMB enumeration"}],
  19:[{id:"toc-L19-1",uz:"SMB va nima uchun muhim",en:"SMB and why it matters"},{id:"toc-L19-2",uz:"Ulashmalarni sanash",en:"Enumerating shares"},{id:"toc-L19-3",uz:"Asosiy vositalar",en:"The core tools"},{id:"toc-L19-4",uz:"EternalBlue va SMB zaifliklari",en:"EternalBlue and SMB vulnerabilities"},{id:"toc-L19-5",uz:"Interaktiv simulyator: SMBv1 zaif vs yangilangan",en:"Interactive simulator: vulnerable SMBv1 vs patched"},{id:"toc-L19-6",uz:"SMB vositalari",en:"The SMB tools"},{id:"toc-L19-7",uz:"Amaliyot: ulashmalarni ko'rish",en:"Practice: listing shares"}],
  20:[{id:"toc-L20-1",uz:"Wireshark nima?",en:"What is Wireshark?"},{id:"toc-L20-2",uz:"Ish jarayoni",en:"Workflow"},{id:"toc-L20-3",uz:"Ikki xil filtr",en:"Two kinds of filter"},{id:"toc-L20-4",uz:"Follow Stream va tshark",en:"Follow Stream and tshark"},{id:"toc-L20-5",uz:"Interaktiv simulyator: HTTP vs HTTPS Follow Stream",en:"Interactive simulator: HTTP vs HTTPS Follow Stream"},{id:"toc-L20-6",uz:"Foydali displey filtrlari",en:"Useful display filters"},{id:"toc-L20-7",uz:"Amaliyot: parolni ko'rish",en:"Practice: spotting a password"}],
  21:[{id:"toc-L21-1",uz:"Metasploit nima?",en:"What is Metasploit?"},{id:"toc-L21-2",uz:"Ekspluatatsiya oqimi",en:"The exploitation flow"},{id:"toc-L21-3",uz:"Modul turlari",en:"Module types"},{id:"toc-L21-4",uz:"Sessiya, shell va Meterpreter",en:"Sessions, shells and Meterpreter"},{id:"toc-L21-5",uz:"Ma'lumotlar bazasi va ish maydoni",en:"Database and workspaces"},{id:"toc-L21-6",uz:"Bind va reverse shell",en:"Bind vs reverse shell"},{id:"toc-L21-7",uz:"Interaktiv simulyator: nega reverse shell ishlaydi?",en:"Interactive simulator: why does a reverse shell work?"},{id:"toc-L21-8",uz:"Amaliyot: msfconsole ish oqimi",en:"Practice: the msfconsole workflow"}],
  22:[{id:"toc-L22-1",uz:"msfvenom nima?",en:"What is msfvenom?"},{id:"toc-L22-2",uz:"Payload → shell oqimi",en:"Payload → shell flow"},{id:"toc-L22-3",uz:"LHOST, LPORT va formatlar",en:"LHOST, LPORT and formats"},{id:"toc-L22-4",uz:"Staged, stageless va handler",en:"Staged, stageless and the handler"},{id:"toc-L22-5",uz:"Nomlash qoidalari",en:"Naming conventions"},{id:"toc-L22-6",uz:"Meterpreter",en:"Meterpreter"},{id:"toc-L22-7",uz:"multi/handler bilan ushlash",en:"Catching with multi/handler"},{id:"toc-L22-8",uz:"Interaktiv simulyator: payload nomi handler bilan mos kelishi shart",en:"Interactive simulator: the payload name must match the handler"},{id:"toc-L22-9",uz:"Web shells (veb-qobiqlar)",en:"Web shells"}],
  23:[{id:"toc-L23-1",uz:"searchsploit va Exploit-DB",en:"searchsploit and Exploit-DB"},{id:"toc-L23-2",uz:"Topish oqimi",en:"The find flow"},{id:"toc-L23-3",uz:"Qidiruv maslahatlari",en:"Search tips"},{id:"toc-L23-4",uz:"Ko'rish, nusxalash va oflayn qiymati",en:"Viewing, copying and offline value"},{id:"toc-L23-5",uz:"Interaktiv simulyator: ko'r-ko'rona ishga tushirish vs avval o'qish",en:"Interactive simulator: running blindly vs reading first"},{id:"toc-L23-6",uz:"searchsploit parametrlari",en:"searchsploit options"},{id:"toc-L23-7",uz:"Amaliyot: ekspluatatsiya qidirish",en:"Practice: finding an exploit"}],
  24:[{id:"toc-L24-1",uz:"Hydra nima?",en:"What is Hydra?"},{id:"toc-L24-2",uz:"Brute-force oqimi",en:"The brute-force flow"},{id:"toc-L24-3",uz:"Sintaksis va parametrlar",en:"Syntax and parameters"},{id:"toc-L24-4",uz:"HTTP forma hujumi",en:"HTTP form attack"},{id:"toc-L24-5",uz:"Interaktiv simulyator: himoyasiz server vs fail2ban",en:"Interactive simulator: unprotected server vs fail2ban"},{id:"toc-L24-6",uz:"Hydra parametrlari",en:"Hydra parameters"},{id:"toc-L24-7",uz:"Amaliyot: SSH brute-force",en:"Practice: SSH brute-force"}],
  25:[{id:"toc-L25-1",uz:"John the Ripper nima?",en:"What is John the Ripper?"},{id:"toc-L25-2",uz:"Buzish oqimi",en:"The cracking flow"},{id:"toc-L25-3",uz:"unshadow va hash formatlari",en:"unshadow and hash formats"},{id:"toc-L25-4",uz:"Rejimlar va qoidalar",en:"Modes and rules"},{id:"toc-L25-5",uz:"Interaktiv simulyator: qoidasiz vs --rules bilan",en:"Interactive simulator: without rules vs with --rules"},{id:"toc-L25-6",uz:"John rejimlari",en:"John's modes"},{id:"toc-L25-7",uz:"Amaliyot: hashni buzish",en:"Practice: cracking a hash"}],
  26:[{id:"toc-L26-1",uz:"Hashcat nima?",en:"What is Hashcat?"},{id:"toc-L26-2",uz:"Hujum rejimlari (-a)",en:"Attack modes (-a)"},{id:"toc-L26-3",uz:"Interaktiv simulyator: CPU vs GPU tezligi",en:"Interactive simulator: CPU vs GPU speed"},{id:"toc-L26-4",uz:"Hash turini aniqlash (-m)",en:"Identifying the hash type (-m)"},{id:"toc-L26-5",uz:"Maskalar va qoidalar",en:"Masks and rules"},{id:"toc-L26-6",uz:"Hashcat buzish oqimi",en:"The Hashcat cracking flow"},{id:"toc-L26-7",uz:"Amaliyot: NTLM hashni buzish",en:"Practice: cracking an NTLM hash"}],
  27:[{id:"toc-L27-1",uz:"Burp Suite nima?",en:"What is Burp Suite?"},{id:"toc-L27-2",uz:"Proksi qanday ishlaydi",en:"How the proxy works"},{id:"toc-L27-3",uz:"Asosiy komponentlar",en:"Core components"},{id:"toc-L27-4",uz:"Proksi bilan test oqimi",en:"Testing with the proxy"},{id:"toc-L27-5",uz:"Intruder hujum turlari",en:"Intruder attack types"},{id:"toc-L27-6",uz:"Interaktiv simulyator: Sniper vs Cluster bomb",en:"Interactive simulator: Sniper vs Cluster bomb"},{id:"toc-L27-7",uz:"Community va Professional",en:"Community vs Professional"},{id:"toc-L27-8",uz:"Amaliyot: so'rovni ushlash",en:"Practice: intercepting a request"}],
  28:[{id:"toc-L28-1",uz:"Ijtimoiy muhandislik va SET",en:"Social engineering and SET"},{id:"toc-L28-2",uz:"Asosiy turlari",en:"Main types"},{id:"toc-L28-3",uz:"Phishing oqimi (misol)",en:"Phishing flow (example)"},{id:"toc-L28-4",uz:"SET (Social-Engineer Toolkit)",en:"SET (Social-Engineer Toolkit)"},{id:"toc-L28-5",uz:"Himoya",en:"Defense"},{id:"toc-L28-6",uz:"Interaktiv simulyator: MFA'siz vs MFA bilan",en:"Interactive simulator: without MFA vs with MFA"},{id:"toc-L28-7",uz:"Himoya qatlamlari",en:"Layers of defense"},{id:"toc-L28-8",uz:"Amaliyot: SET menyusi",en:"Practice: the SET menu"}],
  29:[{id:"toc-L29-1",uz:"Imtiyozlarni oshirish nima?",en:"What is privilege escalation?"},{id:"toc-L29-2",uz:"Linux privesc tekshiruvi",en:"Linux privesc checks"},{id:"toc-L29-3",uz:"Keng tarqalgan vektorlar",en:"Common vectors"},{id:"toc-L29-4",uz:"Interaktiv simulyator: yoziladigan cron skripti",en:"Interactive simulator: a writable cron script"},{id:"toc-L29-5",uz:"Asosiy privesc vektorlari",en:"The main privesc vectors"},{id:"toc-L29-6",uz:"Amaliyot: birinchi tekshiruvlar",en:"Practice: the first checks"}],
  30:[{id:"toc-L30-1",uz:"Pentestning yakuniy bosqichi",en:"The final phase of a pentest"},{id:"toc-L30-2",uz:"Professional hisobot tuzilishi",en:"Professional report structure"},{id:"toc-L30-3",uz:"Jiddiylik va CVSS",en:"Severity and CVSS"},{id:"toc-L30-4",uz:"Yaxshi topilma qanday yoziladi",en:"How to write a good finding"},{id:"toc-L30-5",uz:"Interaktiv simulyator: noaniq vs tuzilgan topilma",en:"Interactive simulator: vague vs structured finding"},{id:"toc-L30-6",uz:"Jiddiylik darajalari (CVSS)",en:"Severity levels (CVSS)"},{id:"toc-L30-7",uz:"Amaliyot: topilma tuzilishi",en:"Practice: a finding's anatomy"}],
  31:[{id:"toc-L31-1",uz:"Imtiyozlarni oshirish nima?",en:"What is privilege escalation?"},{id:"toc-L31-2",uz:"Nega bu muhim?",en:"Why does it matter?"},{id:"toc-L31-3",uz:"Umumiy jarayon",en:"The general process"},{id:"toc-L31-4",uz:"Interaktiv simulyator: tasodifiy urinish vs metodik enumeratsiya",en:"Interactive simulator: random guessing vs methodical enumeration"}],
  32:[{id:"toc-L32-1",uz:"Enumeratsiya — birinchi qadam",en:"Enumeration — the first step"},{id:"toc-L32-2",uz:"Tizim ma'lumotlari",en:"System information"},{id:"toc-L32-3",uz:"Jarayonlar (ps)",en:"Processes (ps)"},{id:"toc-L32-4",uz:"Muhit o'zgaruvchilari (env)",en:"Environment variables (env)"},{id:"toc-L32-5",uz:"Foydalanuvchilar, huquqlar va fayllar",en:"Users, privileges and files"},{id:"toc-L32-6",uz:"Tarmoq (ifconfig, ip route, netstat)",en:"Network (ifconfig, ip route, netstat)"},{id:"toc-L32-7",uz:"find buyrug'i",en:"The find command"},{id:"toc-L32-8",uz:"Interaktiv simulyator: tezkor vs puxta enumeratsiya",en:"Interactive simulator: quick vs thorough enumeration"}],
  33:[{id:"toc-L33-1",uz:"Avtomatik enumeratsiya vositalari",en:"Automated enumeration tools"},{id:"toc-L33-2",uz:"Mashhur vositalar",en:"Popular tools"},{id:"toc-L33-3",uz:"Muhit vositani tanlaydi",en:"The environment picks the tool"},{id:"toc-L33-4",uz:"Interaktiv simulyator: bitta vosita vs ikkinchi vosita bilan tekshirish",en:"Interactive simulator: one tool vs cross-checking with a second"},{id:"toc-L33-5",uz:"Ishlatish",en:"Usage"}],
  34:[{id:"toc-L34-1",uz:"Kernel exploit nima?",en:"What is a kernel exploit?"},{id:"toc-L34-2",uz:"Metodologiya",en:"Methodology"},{id:"toc-L34-3",uz:"Tadqiqot manbalari",en:"Research sources"},{id:"toc-L34-4",uz:"Ehtiyotkorlik",en:"Caution"},{id:"toc-L34-5",uz:"Interaktiv simulyator: beparvo vs ehtiyotkor",en:"Interactive simulator: reckless vs careful"}],
  35:[{id:"toc-L35-1",uz:"Sudo huquqlari",en:"Sudo rights"},{id:"toc-L35-2",uz:"Ilova funksiyalarini suiiste'mol qilish",en:"Abusing application functions"},{id:"toc-L35-3",uz:"LD_PRELOAD",en:"LD_PRELOAD"},{id:"toc-L35-4",uz:"Interaktiv simulyator: env_keep LD_PRELOAD ni saqlaydimi?",en:"Interactive simulator: does env_keep preserve LD_PRELOAD?"},{id:"toc-L35-5",uz:"LD_PRELOAD amalda",en:"LD_PRELOAD in practice"}],
  36:[{id:"toc-L36-1",uz:"SUID nima?",en:"What is SUID?"},{id:"toc-L36-2",uz:"SUID/SGID fayllarni topish",en:"Finding SUID/SGID files"},{id:"toc-L36-3",uz:"Ekspluatatsiya 1: /etc/shadow orqali",en:"Exploitation 1: via /etc/shadow"},{id:"toc-L36-4",uz:"Ekspluatatsiya 2: /etc/passwd ga root foydalanuvchi",en:"Exploitation 2: a root user in /etc/passwd"},{id:"toc-L36-5",uz:"Interaktiv simulyator: qaysi yo'l tezroq?",en:"Interactive simulator: which path is faster?"}],
  37:[{id:"toc-L37-1",uz:"Capabilities (imkoniyatlar)",en:"Capabilities"},{id:"toc-L37-2",uz:"Cron Jobs (rejalashtirilgan vazifalar)",en:"Cron Jobs"},{id:"toc-L37-3",uz:"Cron ekspluatatsiyasi",en:"Cron exploitation"},{id:"toc-L37-4",uz:"PATH-in-cron va wildcard",en:"PATH-in-cron and wildcards"},{id:"toc-L37-5",uz:"Interaktiv simulyator: wildcard inyeksiyasi",en:"Interactive simulator: wildcard injection"}],
  38:[{id:"toc-L38-1",uz:"PATH nima?",en:"What is PATH?"},{id:"toc-L38-2",uz:"PATH hijacking",en:"PATH hijacking"},{id:"toc-L38-3",uz:"PATH ekspluatatsiyasi",en:"PATH exploitation"},{id:"toc-L38-4",uz:"Interaktiv simulyator: qachon PATH hijacking ishlaydi?",en:"Interactive simulator: when does PATH hijacking work?"},{id:"toc-L38-5",uz:"NFS va no_root_squash",en:"NFS and no_root_squash"},{id:"toc-L38-6",uz:"NFS ekspluatatsiyasi",en:"NFS exploitation"}],
};
...
function App(){
  ...
  const navProps={setRoute,user,setLang,routeName,onOpenProfile:()=>setProfileOpen(true),onOpenAI:()=>setAiOpen(true)};

  return React.createElement(LangCtx.Provider,{value:lang},
    React.createElement("div",null,
      React.createElement(TopNav,navProps),
...
function LessonL03(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L3-1"},t(lang,"Nega buyruq qatori?","Why the command line?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L3-2"},t(lang,"Buyruq toifalari","Command categories")),
    React.createElement(LayerStack,{layers:[
    ...
    React.createElement(H2,{num:"§3",id:"toc-L3-3"},t(lang,"Navigatsiya va fayllar chuqurroq","Navigation and files in depth")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L3-4"},t(lang,"Fayllarni ko'rish","Viewing files")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L3-5"},t(lang,"Quvur va yo'naltirish","Pipes and redirection")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L3-6"},t(lang,"Interaktiv simulyator: qo'lda o'qish vs quvur bilan filtrlash","Interactive simulator: reading by hand vs filtering with a pipe")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L3-7"},t(lang,"Wildcard va yordam","Wildcards and help")),
    ...
    React.createElement(H2,{num:"§8",id:"toc-L3-8"},t(lang,"Quvur qanday oqadi","How a pipe flows")),
    ...
    React.createElement(H2,{num:"§9",id:"toc-L3-9"},t(lang,"Amaliyot: haqiqiy natija","Practice: real output")),
...
function LessonL06(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L6-1"},t(lang,"apt nima?","What is apt?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L6-2"},t(lang,"Paket o'rnatish oqimi","The package-install flow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L6-3"},t(lang,"update va upgrade farqi","update vs upgrade")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L6-4"},t(lang,"Interaktiv simulyator: update'ni tashlab ketsangiz nima bo'ladi?","Interactive simulator: what happens if you skip update?")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L6-5"},t(lang,"Asosiy buyruqlar","Core commands")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L6-6"},t(lang,"Omborlar va metapaketlar","Repositories and metapackages")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L6-7"},t(lang,"apt buyruqlari qatlamma-qatlam","The apt commands, layer by layer")),
    ...
    React.createElement(H2,{num:"§8",id:"toc-L6-8"},t(lang,"Amaliyot: dastur o'rnatish","Practice: installing a tool")),
...
function LessonL14(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L14-1"},t(lang,"DNS enumeratsiya nima uchun?","Why DNS enumeration?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L14-2"},t(lang,"Enumeratsiya oqimi","Enumeration flow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L14-3"},t(lang,"DNS yozuv turlari","DNS record types")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L14-4"},t(lang,"Zona transferi va brute-force","Zone transfer and brute-force")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L14-5"},t(lang,"Interaktiv simulyator: AXFR ochiq yoki yopiqmi?","Interactive simulator: is AXFR open or restricted?")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L14-6"},t(lang,"Amaliyot: yozuvlarni so'rash","Practice: querying records")),
...
function LessonL16(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L16-1"},t(lang,"Nikto nima?","What is Nikto?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L16-2"},t(lang,"Skan oqimi","Scan flow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L16-3"},t(lang,"Nikto nimalarni topadi?","What Nikto finds")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L16-4"},t(lang,"Sozlamalar va proksi","Options and proxy")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L16-5"},t(lang,"Interaktiv simulyator: cheklovsiz skan WAF'ga uchraydi","Interactive simulator: an unfiltered scan meets a WAF")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L16-6"},t(lang,"Amaliyot: veb-serverni skanerlash","Practice: scanning a web server")),
...
function LessonL20(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L20-1"},t(lang,"Wireshark nima?","What is Wireshark?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L20-2"},t(lang,"Ish jarayoni","Workflow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L20-3"},t(lang,"Ikki xil filtr","Two kinds of filter")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L20-4"},t(lang,"Follow Stream va tshark","Follow Stream and tshark")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L20-5"},t(lang,"Interaktiv simulyator: HTTP vs HTTPS Follow Stream","Interactive simulator: HTTP vs HTTPS Follow Stream")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L20-6"},t(lang,"Foydali displey filtrlari","Useful display filters")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L20-7"},t(lang,"Amaliyot: parolni ko'rish","Practice: spotting a password")),
...
function LessonL24(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L24-1"},t(lang,"Hydra nima?","What is Hydra?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L24-2"},t(lang,"Brute-force oqimi","The brute-force flow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L24-3"},t(lang,"Sintaksis va parametrlar","Syntax and parameters")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L24-4"},t(lang,"HTTP forma hujumi","HTTP form attack")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L24-5"},t(lang,"Interaktiv simulyator: himoyasiz server vs fail2ban","Interactive simulator: unprotected server vs fail2ban")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L24-6"},t(lang,"Hydra parametrlari","Hydra parameters")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L24-7"},t(lang,"Amaliyot: SSH brute-force","Practice: SSH brute-force")),
...
function LessonL25(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L25-1"},t(lang,"John the Ripper nima?","What is John the Ripper?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L25-2"},t(lang,"Buzish oqimi","The cracking flow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L25-3"},t(lang,"unshadow va hash formatlari","unshadow and hash formats")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L25-4"},t(lang,"Rejimlar va qoidalar","Modes and rules")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L25-5"},t(lang,"Interaktiv simulyator: qoidasiz vs --rules bilan","Interactive simulator: without rules vs with --rules")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L25-6"},t(lang,"John rejimlari","John's modes")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L25-7"},t(lang,"Amaliyot: hashni buzish","Practice: cracking a hash")),
...
function LessonL27(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L27-1"},t(lang,"Burp Suite nima?","What is Burp Suite?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L27-2"},t(lang,"Proksi qanday ishlaydi","How the proxy works")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L27-3"},t(lang,"Asosiy komponentlar","Core components")),
    React.createElement(LayerStack,{layers:[
    ...
    React.createElement(H2,{num:"§4",id:"toc-L27-4"},t(lang,"Proksi bilan test oqimi","Testing with the proxy")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L27-5"},t(lang,"Intruder hujum turlari","Intruder attack types")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L27-6"},t(lang,"Interaktiv simulyator: Sniper vs Cluster bomb","Interactive simulator: Sniper vs Cluster bomb")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L27-7"},t(lang,"Community va Professional","Community vs Professional")),
    ...
    React.createElement(H2,{num:"§8",id:"toc-L27-8"},t(lang,"Amaliyot: so'rovni ushlash","Practice: intercepting a request")),
...
function LessonL02(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L2-1"},t(lang,"Kali'ni o'rnatish usullari","Ways to install Kali")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L2-2"},t(lang,"O'rnatish oqimi","The install flow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L2-3"},t(lang,"Yuklab olishni tekshirish nima uchun muhim","Why verifying the download matters")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L2-4"},t(lang,"Interaktiv simulyator: ISO tasdiqlandimi yoki buzilganmi?","Interactive simulator: is the ISO verified or tampered?")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L2-5"},t(lang,"O'rnatishdan keyingi birinchi qadamlar","First steps after install")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L2-6"},t(lang,"VM tarmoq rejimlari","VM network modes")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L2-7"},t(lang,"VM tarmoq rejimlarini solishtirish","Comparing VM network modes")),
    ...
    React.createElement(H2,{num:"§8",id:"toc-L2-8"},t(lang,"Amaliyot: ISO ni tekshirish","Practice: verify the ISO")),
...
function LessonL04(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L4-1"},t(lang,"Linux fayl tizimi (FHS)","The Linux file system (FHS)")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L4-2"},t(lang,"Asosiy kataloglar","The key directories")),
    React.createElement(LayerStack,{layers:[
    ...
    React.createElement(H2,{num:"§3",id:"toc-L4-3"},t(lang,"Pentester uchun nega muhim?","Why it matters to a pentester")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L4-4"},t(lang,"Interaktiv simulyator: oddiy foydalanuvchi vs root","Interactive simulator: regular user vs root")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L4-5"},t(lang,"Mutlaq va nisbiy yo'llar","Absolute vs relative paths")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L4-6"},t(lang,"Mutlaq va nisbiy yo'l — solishtirish","Absolute vs relative path — compared")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L4-7"},t(lang,"Amaliyot: fayl tizimini aylanish","Practice: walking the file system")),
...
function LessonL05(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L5-1"},t(lang,"Foydalanuvchilar va guruhlar","Users and groups")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L5-2"},t(lang,"Ruxsatlarni o'qish (rwx)","Reading permissions (rwx)")),
    React.createElement(LayerStack,{layers:[
    ...
    React.createElement(H2,{num:"§3",id:"toc-L5-3"},t(lang,"Sakkizlik (octal) matematika","Octal math")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L5-4"},t(lang,"chmod, chown va amaliyot","chmod, chown and practice")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L5-5"},t(lang,"SUID, SGID va sudo","SUID, SGID and sudo")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L5-6"},t(lang,"Interaktiv simulyator: xavfsiz vs xavfli SUID","Interactive simulator: safe vs risky SUID")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L5-7"},t(lang,"Sakkizlik va simvolik — ikki usul","Octal vs symbolic — two ways")),
    ...
    React.createElement(H2,{num:"§8",id:"toc-L5-8"},t(lang,"Amaliyot: ruxsatlarni o'qish","Practice: reading permissions")),
...
function LessonL07(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L7-1"},t(lang,"Nega bash skript?","Why bash scripting?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L7-2"},t(lang,"Skript qanday ishlaydi","How a script runs")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L7-3"},t(lang,"O'zgaruvchilar va qo'shtirnoq","Variables and quoting")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L7-4"},t(lang,"Shartlar va sikllar","Conditions and loops")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L7-5"},t(lang,"Amaliy recon skripti","A practical recon script")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L7-6"},t(lang,"Bash qurilishlari","Bash building blocks")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L7-7"},t(lang,"Interaktiv simulyator: qo'lda vs skript bilan","Interactive simulator: by hand vs with a script")),
...
function LessonL08(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L8-1"},t(lang,"Tarmoq holatini ko'rish","Inspecting the network")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L8-2"},t(lang,"Foydali buyruqlar","Useful commands")),
    React.createElement(LayerStack,{layers:[
    ...
    React.createElement(H2,{num:"§3",id:"toc-L8-3"},t(lang,"ip a chiqishini o'qish","Reading ip a output")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L8-4"},t(lang,"Interaktiv simulyator: zanjir qayerda uzilgan?","Interactive simulator: where does the chain break?")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L8-5"},t(lang,"MAC manzilni o'zgartirish","Changing the MAC address")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L8-6"},t(lang,"Amaliyot: ip a chiqishini o'qish","Practice: reading ip a")),
...
function LessonL09(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L9-1"},t(lang,"Xizmatlar va systemd","Services and systemd")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L9-2"},t(lang,"Xizmat hayot tsikli","The service lifecycle")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L9-3"},t(lang,"start va enable: qanday farq bor?","start vs enable: what's the difference?")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L9-4"},t(lang,"Interaktiv simulyator: reboot'dan keyin nima bo'ladi?","Interactive simulator: what happens after a reboot?")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L9-5"},t(lang,"Pentestda kerak bo'ladigan xizmatlar","Services you'll need in a pentest")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L9-6"},t(lang,"Loglarni ko'rish","Viewing logs")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L9-7"},t(lang,"systemctl — qisqacha ma'lumotnoma","systemctl — quick reference")),
    ...
    React.createElement(H2,{num:"§8",id:"toc-L9-8"},t(lang,"Amaliyot: xizmat holati","Practice: service status")),
...
function LessonL10(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L10-1"},t(lang,"600+ vosita, tartibli","600+ tools, organized")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L10-2"},t(lang,"Asosiy toifalar","Main categories")),
    React.createElement(LayerStack,{layers:[
    ...
    React.createElement(H2,{num:"§3",id:"toc-L10-3"},t(lang,"Toifalar pentest bosqichlariga mos","Categories map to pentest phases")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L10-4"},t(lang,"Vositani topish va o'rnatish — asoslar","Finding and installing a tool — the basics")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L10-5"},t(lang,"Vosita bilan yordam olish","Getting help with a tool")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L10-6"},t(lang,"Interaktiv simulyator: omborda bormi, yo'qmi?","Interactive simulator: in the repo, or not?")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L10-7"},t(lang,"Amaliyot: vosita qidirish","Practice: searching for a tool")),
...
function LessonL12(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L12-1"},t(lang,"Netdiscover nima?","What is Netdiscover?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L12-2"},t(lang,"ARP orqali topish","Discovery via ARP")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L12-3"},t(lang,"Passiv va aktiv rejim","Passive vs active mode")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L12-4"},t(lang,"Interaktiv simulyator: aktiv vs passiv qanday farq qiladi","Interactive simulator: how active differs from passive")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L12-5"},t(lang,"Natijani o'qish","Reading the output")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L12-6"},t(lang,"Netdiscover parametrlari","Netdiscover options")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L12-7"},t(lang,"Amaliyot: tirik xostlar","Practice: live hosts")),
...
function LessonL13(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L13-1"},t(lang,"Masscan nima?","What is Masscan?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L13-2"},t(lang,"Masscan + Nmap ish oqimi","The Masscan + Nmap workflow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L13-3"},t(lang,"Nima uchun bunchalik tez?","Why so fast?")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L13-4"},t(lang,"Tezlikni sozlash — ehtiyotkorlik","Tuning the rate — carefully")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L13-5"},t(lang,"Interaktiv simulyator: ehtiyotkor vs beparvo tezlik","Interactive simulator: careful vs reckless rate")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L13-6"},t(lang,"Masscan va Nmap — vazifa taqsimoti","Masscan vs Nmap — division of labor")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L13-7"},t(lang,"Amaliyot: ikki bosqichli ish oqimi","Practice: the two-stage workflow")),
...
function LessonL15(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L15-1"},t(lang,"theHarvester nima?","What is theHarvester?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L15-2"},t(lang,"Passiv razvedka oqimi","Passive recon flow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L15-3"},t(lang,"Nega passiv razvedka qimmatli?","Why passive recon is valuable")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L15-4"},t(lang,"Interaktiv simulyator: oshkor vs gigienik kompaniya","Interactive simulator: exposed vs hygienic company")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L15-5"},t(lang,"Manbalar va crt.sh","Sources and crt.sh")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L15-6"},t(lang,"theHarvester manbalari","theHarvester sources")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L15-7"},t(lang,"Amaliyot: passiv razvedka","Practice: passive recon")),
...
function LessonL17(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L17-1"},t(lang,"WhatWeb nima?","What is WhatWeb?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L17-2"},t(lang,"Nima aniqlanadi","What it detects")),
    React.createElement(LayerStack,{layers:[
    ...
    React.createElement(H2,{num:"§3",id:"toc-L17-3"},t(lang,"U qanday aniqlaydi?","How it detects")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L17-4"},t(lang,"Agressivlik va keyingi qadam","Aggression and the next step")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L17-5"},t(lang,"Interaktiv simulyator: -a 1 vs -a 4","Interactive simulator: -a 1 vs -a 4")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L17-6"},t(lang,"WhatWeb aniqlash oqimi","WhatWeb detection flow")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L17-7"},t(lang,"Amaliyot: texnologiyalarni aniqlash","Practice: identifying tech")),
...
function LessonL18(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L18-1"},t(lang,"enum4linux nima?","What is enum4linux?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L18-2"},t(lang,"Enumeratsiya oqimi","Enumeration flow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L18-3"},t(lang,"\"Null session\" nima?","What is a null session?")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L18-4"},t(lang,"Nima chiqariladi va ng versiya","What it extracts and the ng version")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L18-5"},t(lang,"Interaktiv simulyator: null session ruxsat etilganmi?","Interactive simulator: is the null session allowed?")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L18-6"},t(lang,"Amaliyot: SMB enumeratsiyasi","Practice: SMB enumeration")),
...
function LessonL19(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L19-1"},t(lang,"SMB va nima uchun muhim","SMB and why it matters")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L19-2"},t(lang,"Ulashmalarni sanash","Enumerating shares")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L19-3"},t(lang,"Asosiy vositalar","The core tools")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L19-4"},t(lang,"EternalBlue va SMB zaifliklari","EternalBlue and SMB vulnerabilities")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L19-5"},t(lang,"Interaktiv simulyator: SMBv1 zaif vs yangilangan","Interactive simulator: vulnerable SMBv1 vs patched")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L19-6"},t(lang,"SMB vositalari","The SMB tools")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L19-7"},t(lang,"Amaliyot: ulashmalarni ko'rish","Practice: listing shares")),
...
function LessonL22(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L22-1"},t(lang,"msfvenom nima?","What is msfvenom?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L22-2"},t(lang,"Payload → shell oqimi","Payload → shell flow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L22-3"},t(lang,"LHOST, LPORT va formatlar","LHOST, LPORT and formats")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L22-4"},t(lang,"Staged, stageless va handler","Staged, stageless and the handler")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L22-5"},t(lang,"Nomlash qoidalari","Naming conventions")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L22-6"},t(lang,"Meterpreter","Meterpreter")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L22-7"},t(lang,"multi/handler bilan ushlash","Catching with multi/handler")),
    ...
    React.createElement(H2,{num:"§8",id:"toc-L22-8"},t(lang,"Interaktiv simulyator: payload nomi handler bilan mos kelishi shart","Interactive simulator: the payload name must match the handler")),
    ...
    React.createElement(H2,{num:"§9",id:"toc-L22-9"},t(lang,"Web shells (veb-qobiqlar)","Web shells")),
...
function LessonL23(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L23-1"},t(lang,"searchsploit va Exploit-DB","searchsploit and Exploit-DB")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L23-2"},t(lang,"Topish oqimi","The find flow")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L23-3"},t(lang,"Qidiruv maslahatlari","Search tips")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L23-4"},t(lang,"Ko'rish, nusxalash va oflayn qiymati","Viewing, copying and offline value")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L23-5"},t(lang,"Interaktiv simulyator: ko'r-ko'rona ishga tushirish vs avval o'qish","Interactive simulator: running blindly vs reading first")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L23-6"},t(lang,"searchsploit parametrlari","searchsploit options")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L23-7"},t(lang,"Amaliyot: ekspluatatsiya qidirish","Practice: finding an exploit")),
...
function LessonL26(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L26-1"},t(lang,"Hashcat nima?","What is Hashcat?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L26-2"},t(lang,"Hujum rejimlari (-a)","Attack modes (-a)")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L26-3"},t(lang,"Interaktiv simulyator: CPU vs GPU tezligi","Interactive simulator: CPU vs GPU speed")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L26-4"},t(lang,"Hash turini aniqlash (-m)","Identifying the hash type (-m)")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L26-5"},t(lang,"Maskalar va qoidalar","Masks and rules")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L26-6"},t(lang,"Hashcat buzish oqimi","The Hashcat cracking flow")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L26-7"},t(lang,"Amaliyot: NTLM hashni buzish","Practice: cracking an NTLM hash")),
...
function LessonL28(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L28-1"},t(lang,"Ijtimoiy muhandislik va SET","Social engineering and SET")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L28-2"},t(lang,"Asosiy turlari","Main types")),
    React.createElement(LayerStack,{layers:[
    ...
    React.createElement(H2,{num:"§3",id:"toc-L28-3"},t(lang,"Phishing oqimi (misol)","Phishing flow (example)")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L28-4"},t(lang,"SET (Social-Engineer Toolkit)","SET (Social-Engineer Toolkit)")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L28-5"},t(lang,"Himoya","Defense")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L28-6"},t(lang,"Interaktiv simulyator: MFA'siz vs MFA bilan","Interactive simulator: without MFA vs with MFA")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L28-7"},t(lang,"Himoya qatlamlari","Layers of defense")),
    ...
    React.createElement(H2,{num:"§8",id:"toc-L28-8"},t(lang,"Amaliyot: SET menyusi","Practice: the SET menu")),
...
function LessonL29(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L29-1"},t(lang,"Imtiyozlarni oshirish nima?","What is privilege escalation?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L29-2"},t(lang,"Linux privesc tekshiruvi","Linux privesc checks")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L29-3"},t(lang,"Keng tarqalgan vektorlar","Common vectors")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L29-4"},t(lang,"Interaktiv simulyator: yoziladigan cron skripti","Interactive simulator: a writable cron script")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L29-5"},t(lang,"Asosiy privesc vektorlari","The main privesc vectors")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L29-6"},t(lang,"Amaliyot: birinchi tekshiruvlar","Practice: the first checks")),
...
function LessonL30(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L30-1"},t(lang,"Pentestning yakuniy bosqichi","The final phase of a pentest")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L30-2"},t(lang,"Professional hisobot tuzilishi","Professional report structure")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L30-3"},t(lang,"Jiddiylik va CVSS","Severity and CVSS")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L30-4"},t(lang,"Yaxshi topilma qanday yoziladi","How to write a good finding")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L30-5"},t(lang,"Interaktiv simulyator: noaniq vs tuzilgan topilma","Interactive simulator: vague vs structured finding")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L30-6"},t(lang,"Jiddiylik darajalari (CVSS)","Severity levels (CVSS)")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L30-7"},t(lang,"Amaliyot: topilma tuzilishi","Practice: a finding's anatomy")),
...
function LessonL31(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L31-1"},t(lang,"Imtiyozlarni oshirish nima?","What is privilege escalation?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L31-2"},t(lang,"Nega bu muhim?","Why does it matter?")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L31-3"},t(lang,"Umumiy jarayon","The general process")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L31-4"},t(lang,"Interaktiv simulyator: tasodifiy urinish vs metodik enumeratsiya","Interactive simulator: random guessing vs methodical enumeration")),
...
function LessonL32(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L32-1"},t(lang,"Enumeratsiya — birinchi qadam","Enumeration — the first step")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L32-2"},t(lang,"Tizim ma'lumotlari","System information")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L32-3"},t(lang,"Jarayonlar (ps)","Processes (ps)")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L32-4"},t(lang,"Muhit o'zgaruvchilari (env)","Environment variables (env)")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L32-5"},t(lang,"Foydalanuvchilar, huquqlar va fayllar","Users, privileges and files")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L32-6"},t(lang,"Tarmoq (ifconfig, ip route, netstat)","Network (ifconfig, ip route, netstat)")),
    ...
    React.createElement(H2,{num:"§7",id:"toc-L32-7"},t(lang,"find buyrug'i","The find command")),
...
React.createElement(H2,{num:"§8",id:"toc-L32-8"},t(lang,"Interaktiv simulyator: tezkor vs puxta enumeratsiya","Interactive simulator: quick vs thorough enumeration")),
...
function LessonL33(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L33-1"},t(lang,"Avtomatik enumeratsiya vositalari","Automated enumeration tools")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L33-2"},t(lang,"Mashhur vositalar","Popular tools")),
    React.createElement(LayerStack,{layers:[
    ...
    React.createElement(H2,{num:"§3",id:"toc-L33-3"},t(lang,"Muhit vositani tanlaydi","The environment picks the tool")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L33-4"},t(lang,"Interaktiv simulyator: bitta vosita vs ikkinchi vosita bilan tekshirish","Interactive simulator: one tool vs cross-checking with a second")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L33-5"},t(lang,"Ishlatish","Usage")),
...
function LessonL34(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L34-1"},t(lang,"Kernel exploit nima?","What is a kernel exploit?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L34-2"},t(lang,"Metodologiya","Methodology")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L34-3"},t(lang,"Tadqiqot manbalari","Research sources")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L34-4"},t(lang,"Ehtiyotkorlik","Caution")),
...
React.createElement(H2,{num:"§5",id:"toc-L34-5"},t(lang,"Interaktiv simulyator: beparvo vs ehtiyotkor","Interactive simulator: reckless vs careful")),
...
function LessonL35(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L35-1"},t(lang,"Sudo huquqlari","Sudo rights")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L35-2"},t(lang,"Ilova funksiyalarini suiiste'mol qilish","Abusing application functions")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L35-3"},t(lang,"LD_PRELOAD","LD_PRELOAD")),
...
React.createElement(H2,{num:"§4",id:"toc-L35-4"},t(lang,"Interaktiv simulyator: env_keep LD_PRELOAD ni saqlaydimi?","Interactive simulator: does env_keep preserve LD_PRELOAD?")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L35-5"},t(lang,"LD_PRELOAD amalda","LD_PRELOAD in practice")),
...
function LessonL36(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L36-1"},t(lang,"SUID nima?","What is SUID?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L36-2"},t(lang,"SUID/SGID fayllarni topish","Finding SUID/SGID files")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L36-3"},t(lang,"Ekspluatatsiya 1: /etc/shadow orqali","Exploitation 1: via /etc/shadow")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L36-4"},t(lang,"Ekspluatatsiya 2: /etc/passwd ga root foydalanuvchi","Exploitation 2: a root user in /etc/passwd")),
...
React.createElement(H2,{num:"§5",id:"toc-L36-5"},t(lang,"Interaktiv simulyator: qaysi yo'l tezroq?","Interactive simulator: which path is faster?")),
...
function LessonL37(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L37-1"},t(lang,"Capabilities (imkoniyatlar)","Capabilities")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L37-2"},t(lang,"Cron Jobs (rejalashtirilgan vazifalar)","Cron Jobs")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L37-3"},t(lang,"Cron ekspluatatsiyasi","Cron exploitation")),
    ...
    React.createElement(H2,{num:"§4",id:"toc-L37-4"},t(lang,"PATH-in-cron va wildcard","PATH-in-cron and wildcards")),
...
React.createElement(H2,{num:"§5",id:"toc-L37-5"},t(lang,"Interaktiv simulyator: wildcard inyeksiyasi","Interactive simulator: wildcard injection")),
...
function LessonL38(){
  ...
  return React.createElement("section",null,
    React.createElement(NetAnimStyle),
    React.createElement(H2,{num:"§1",id:"toc-L38-1"},t(lang,"PATH nima?","What is PATH?")),
    ...
    React.createElement(H2,{num:"§2",id:"toc-L38-2"},t(lang,"PATH hijacking","PATH hijacking")),
    ...
    React.createElement(H2,{num:"§3",id:"toc-L38-3"},t(lang,"PATH ekspluatatsiyasi","PATH exploitation")),
...
React.createElement(H2,{num:"§4",id:"toc-L38-4"},t(lang,"Interaktiv simulyator: qachon PATH hijacking ishlaydi?","Interactive simulator: when does PATH hijacking work?")),
    ...
    React.createElement(H2,{num:"§5",id:"toc-L38-5"},t(lang,"NFS va no_root_squash","NFS and no_root_squash")),
    ...
    React.createElement(H2,{num:"§6",id:"toc-L38-6"},t(lang,"NFS ekspluatatsiyasi","NFS exploitation")),
