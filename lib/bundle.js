...
function SectionFAT32() {
  ...
  return lang === "en" ? /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement(H2, {
  ...
  }, "1.3 \u2014 FAT12, FAT16, FAT32 and exFAT \u2014 Full Comparison"), /*#__PURE__*/React.createElement(P, null, "Think of each generation as a card \u2014 the most important numbers at a glance:"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, "MAX FILE"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: "var(--text-0)",
      lineHeight: 1.5,
  ...
  }, c.file)), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "rgba(0,0,0,0.2)",
      borderRadius: 6,
      padding: "8px 10px"
  ...
  }, "MAX DISK"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: "var(--text-0)",
      lineHeight: 1.5,
  ...
  }, c.disk)), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "rgba(0,0,0,0.2)",
      borderRadius: 6,
      padding: "8px 10px"
  ...
  }, c.perm)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: "var(--text-2)",
      lineHeight: 1.4,
  ...
  }, c.use))))), /*#__PURE__*/React.createElement(P, {
    style: {
      marginTop: 24
    }
  }, "Max disk size by cluster size (MB / GB / TB):"), /*#__PURE__*/React.createElement("div", {
    style: {
      overflowX: "auto",
      marginTop: 8
    }
  ...
  }, ["Cluster size", "FAT12", "FAT16", "FAT32", "exFAT"].map(h => /*#__PURE__*/React.createElement("th", {
    key: h,
    style: {
      textAlign: "left",
      padding: "7px 10px",
  ...
  }, h)))), /*#__PURE__*/React.createElement("tbody", null, [["512 B", "4,084 × 512 B = 2 MB", "65,524 × 512 B = 32 MB", "268M × 512 B = 128 GB", "—"], ["4 KB", "4,084 × 4 KB = 16 MB", "65,524 × 4 KB = 256 MB", "268M × 4 KB = 1 TB", "268M × 4 KB = 1 TB"], ["32 KB", "4,084 × 32 KB = 128 MB", "65,524 × 32 KB = 2 GB", "268M × 32 KB = 8 TB", "268M × 32 KB = 8 TB"], ["64 KB", "4,084 × 64 KB = 256 MB", "65,524 × 64 KB = 4 GB", "268M × 64 KB = 16 TB", "268M × 64 KB = 16 TB"], ["Max file size", "= Volume", "= Volume", "4 GB − 1 byte (2³²−1 B)", "128 PB (2⁶⁴−1 B)"], ["Permissions (ACL)", "NONE", "NONE", "NONE", "NONE"], ["Journaling", "NONE", "NONE", "NONE", "NONE"]].map((r, i) => /*#__PURE__*/React.createElement("tr", {
    key: i,
    style: {
      borderBottom: "1px solid rgba(255,255,255,0.04)",
      background: i % 2 === 0 ? "transparent" : "rgba(255,255,255,0.015)"
    ...
    style: {
      padding: "6px 10px",
      color: j === 0 ? "var(--text-0)" : i >= 4 && j > 0 ? "var(--c-err)" : "var(--text-1)",
      fontFamily: j === 0 ? "var(--font-mono)" : "inherit",
      fontSize: j === 0 ? 11 : 12,
      fontWeight: i >= 4 && j > 0 ? 600 : 400
    }
  }, c))))))), /*#__PURE__*/React.createElement(Callout, {
    color: "var(--c-err)",
    icon: "warning",
    titleEn: "All four FAT variants share the same fatal flaw: no permissions",
    titleUz: ""
  }, "FAT12, FAT16, FAT32, exFAT \u2014 all four have zero access control. Anyone who can mount the volume (root on Linux, Administrator on Windows) can read and modify every file. When an NTFS disk is rebooted into Linux and mounted as root, the \"protections\" disappear entirely. ", /*#__PURE__*/React.createElement("strong", null, "BitLocker-style encryption is the only correct solution for protecting data against physical access on FAT volumes.")), /*#__PURE__*/React.createElement("h3", {
    className: "mono",
    style: {
      color: "var(--accent)",
      marginTop: 28
...
Get-Volume -DriveLetter D | Select-Object FileSystem, Size, SizeRemaining`))) : /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement(H2, {
  ...
  }, "1.3 \u2014 FAT12, FAT16, FAT32 va exFAT \u2014 To'liq Taqqoslash"), /*#__PURE__*/React.createElement(P, null, "To'rtta FAT avlodining eng muhim ko'rsatkichlarini eslab qolish uchun \u2014 har birini bir karta sifatida tasavvur qiling:"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))",
      gap: 14,
  ...
  }, "MAKS FAYL"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: "var(--text-0)",
      lineHeight: 1.5,
  ...
  }, "MAKS DISK"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: "var(--text-0)",
      lineHeight: 1.5,
  ...
  }, "Klaster hajmiga qarab maks disk hajmi (MB / GB / TB):"), /*#__PURE__*/React.createElement("div", {
    style: {
      overflowX: "auto",
      marginTop: 8
    }
  ...
  }, ["Klaster hajmi", "FAT12", "FAT16", "FAT32", "exFAT"].map(h => /*#__PURE__*/React.createElement("th", {
    key: h,
    style: {
      textAlign: "left",
      padding: "7px 10px",
  ...
  }, h)))), /*#__PURE__*/React.createElement("tbody", null, [["512 B", "4,084 × 512 B = 2 MB", "65,524 × 512 B = 32 MB", "268M × 512 B = 128 GB", "—"], ["4 KB", "4,084 × 4 KB = 16 MB", "65,524 × 4 KB = 256 MB", "268M × 4 KB = 1 TB", "268M × 4 KB = 1 TB"], ["32 KB", "4,084 × 32 KB = 128 MB", "65,524 × 32 KB = 2 GB", "268M × 32 KB = 8 TB", "268M × 32 KB = 8 TB"], ["64 KB", "4,084 × 64 KB = 256 MB", "65,524 × 64 KB = 4 GB", "268M × 64 KB = 16 TB", "268M × 64 KB = 16 TB"], ["Maks fayl hajmi", "= Hajm", "= Hajm", "4 GB − 1 bayt (2³²−1 B)", "128 PB (2⁶⁴−1 B)"], ["Ruxsatlar (ACL)", "YO'Q", "YO'Q", "YO'Q", "YO'Q"], ["Jurnalling", "YO'Q", "YO'Q", "YO'Q", "YO'Q"]].map((r, i) => /*#__PURE__*/React.createElement("tr", {
    key: i,
    style: {
      borderBottom: "1px solid rgba(255,255,255,0.04)",
      background: i % 2 === 0 ? "transparent" : "rgba(255,255,255,0.015)"
    ...
    style: {
      padding: "6px 10px",
      color: j === 0 ? "var(--text-0)" : i === 4 && j > 0 ? "var(--c-err)" : i === 5 && j > 0 ? "var(--c-err)" : "var(--text-1)",
      fontFamily: j === 0 ? "var(--font-mono)" : "inherit",
      fontSize: j === 0 ? 11 : 12,
      fontWeight: i >= 4 && j > 0 ? 600 : 400
    }
