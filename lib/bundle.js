...
const LESSONS = {
  ...
  2: {
    num: "L02",
    section: "01",
    uz: "Boot jarayoni va Syscall oqimi",
    en: "Boot Process & Syscall Flow",
    subUz: "UEFI dan login gacha, tizim chaqiruvlari va xavfsizlik",
    subEn: "UEFI to login, syscalls and security"
  }
};
...
function LessonScreen({
  ...
  }, /*#__PURE__*/React.createElement(LessonTOC, {
    lessonNum: lessonNum
  }), /*#__PURE__*/React.createElement("div", {
    className: "page",
    style: {
...
const FALLBACK_QUESTIONS = {
  1: [{
    ...
    uz: "Windows arxitekturasidagi Executive, Microkernel va HAL qatlamlarini tushuntiring. Ularning har biri qanday vazifani bajaradi?",
    en: "Explain the Executive, Microkernel and HAL layers in Windows architecture. What does each layer do?"
  }, {
    uz: "ntoskrnl.exe ichida qanday komponentlar mavjud va ular bir-biri bilan qanday o'zaro ishlaydi?",
    en: "What components exist inside ntoskrnl.exe and how do they interact with each other?"
  }],
  2: [{
    uz: "Windows boot ketma-ketligini UEFI'dan login ekraniga qadar bosqichma-bosqich tushuntiring. Har bir bosqich keyingisini qanday tekshiradi?",
    en: "Walk through the Windows boot sequence step-by-step from UEFI to login. How does each stage verify the next?"
  }, {
    uz: "ReadFile() chaqiruvi user mode'dan kernel mode'gacha va orqaga qaytishida qaysi qatlamlardan o'tadi? ntdll va syscall buyrug'ining roli nima?",
    en: "Which layers does ReadFile() traverse from user mode to kernel and back? What is the role of ntdll and the syscall instruction?"
  }, {
    uz: "Secure Boot kriptografik zanjiri qanday ishlaydi va BlackLotus rootkiti uni qanday chetlab o'tdi?",
    en: "How does the Secure Boot cryptographic chain work and how did the BlackLotus rootkit bypass it?"
  }]
};
...
Return STRICT JSON only: {"score":<0-100>,"passed":<score>=70>,"key_points":["point"],"missing":["missing"],"feedback":"1-2 sentences in ${lang === "en" ? "English" : "Uzbek"}"}`;
          ...
          results.push({
            ...
            passed: score >= 70,
            key_points: [],
            missing: ["AI kalit o'rnatilmagan"],
            feedback: "Tweaks → AI Tekshiruvchi bo'limida kalit o'rnating."
          });
        }
      } catch {
        results.push({
          ...
          passed: false,
          key_points: [],
          missing: ["Baholashda xatolik"],
          feedback: "AI so'rovda xatolik yuz berdi."
        });
      }
    }
