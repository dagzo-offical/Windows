...
function TopNav({
  ...
  }, user?.name || "Akmal K."), /*#__PURE__*/React.createElement("span", {
    className: "mono",
    style: {
      fontSize: 10,
      color: "var(--accent)"
...
function DashboardScreen({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(TopNav, {
    ...
    className: "eyebrow"
  }, /*#__PURE__*/React.createElement(LiveDot, null), " \xA0OPERATOR_ID: AK-4820 \xB7 LAST_LOGIN: 14m ago"), /*#__PURE__*/React.createElement("h1", {
    className: "display",
    style: {
      fontSize: 40,
      margin: "10px 0 6px",
  ...
  }, lang === "en" ? "Welcome back, Akmal" : "Xush kelibsiz, Akmal", /*#__PURE__*/React.createElement("span", {
    className: "caret"
  ...
  }, lang === "en" ? "14-day streak · 4,820 XP · Section 01 · Lesson 1 of 20 in progress" : "14 kunlik seriya · 4,820 XP · 01-bo'lim · 20 darsdan 1-darsi davom etmoqda")), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-primary",
    onClick: () => setRoute({
      name: "lesson",
      section: 1,
...
function SectionScreen({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(TopNav, {
    ...
    style: {
      ...
      height: 44,
      borderRadius: "50%",
      background: "linear-gradient(135deg, var(--c-attack), var(--c-warn))",
      color: "#04060d",
      fontWeight: 700,
      display: "grid",
      placeItems: "center",
  ...
  }, lang === "en" ? "Aziz R." : data.instructorUz), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: "var(--text-3)"
    }
...
function LessonHero() {
  ...
  }, lang === "en" ? "Updated" : "Yangilandi", " 2026.05.10 \xB7 Aziz R.")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 24,
      padding: 18,
...
flowchart TD
  ...
  }, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "Secure Boot enforces a cryptographic chain \u2014 UEFI verifies the bootloader, the bootloader verifies the kernel, the kernel verifies signed drivers. Breaking this chain is the dream of every bootkit (and how rootkits like ", /*#__PURE__*/React.createElement("code", null, "BlackLotus"), " made the news).") : /*#__PURE__*/React.createElement(React.Fragment, null, "Secure Boot kriptografik zanjirni ta'minlaydi \u2014 UEFI bootloader'ni tekshiradi, bootloader yadroni, yadro esa imzolangan drayverlarni. Bu zanjirni buzish har bir bootkit'ning orzusi (va ", /*#__PURE__*/React.createElement("code", null, "BlackLotus"), " kabi rootkit'lar shuning uchun yangiliklarda paydo bo'ldi).")));
}
...
sequenceDiagram
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }), /*#__PURE__*/React.createElement(P, null, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "Every privileged operation \u2014 opening a file, allocating memory, sending a network packet \u2014 follows the same path: Win32 API \u2192 ntdll \u2192 syscall instruction \u2192 executive. Knowing this path is non-negotiable for kernel debugging, malware analysis, and EDR work.") : /*#__PURE__*/React.createElement(React.Fragment, null, "Har qanday imtiyozli operatsiya \u2014 fayl ochish, xotira ajratish, tarmoq paketi yuborish \u2014 bir xil yo'ldan o'tadi: Win32 API \u2192 ntdll \u2192 syscall buyrug'i \u2192 executive. Bu yo'lni bilish \u2014 kernel debugging, malware tahlili va EDR ishi uchun shart.")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 22
    }
  }, /*#__PURE__*/React.createElement(MermaidDiagram, {
    ...
    color: "var(--c-attack)",
    icon: "skull",
    titleUz: "Hujum nuqtasi",
    titleEn: "Attack surface"
  }, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "EDRs hook the user-mode side of this chain (ntdll). That's why advanced malware uses ", /*#__PURE__*/React.createElement("em", null, "direct syscalls"), " \u2014 skipping the hooked functions and invoking the syscall instruction itself.") : /*#__PURE__*/React.createElement(React.Fragment, null, "EDR'lar bu zanjirning user-mode tomonini ushlaydi (ntdll). Shuning uchun rivojlangan malware ", /*#__PURE__*/React.createElement("em", null, "to'g'ridan-to'g'ri syscall"), "'lardan foydalanadi \u2014 ushlangan funksiyalardan o'tib, syscall buyrug'ining o'zini chaqirib.")));
}
...
function App() {
  ...
  const setRoute = r => {
    _setRoute(r);
    try {
      sessionStorage.setItem("wa_route", JSON.stringify(r));
    } catch {}
    window.scrollTo({
      top: 0,
      behavior: "instant"
  ...
  return /*#__PURE__*/React.createElement(LangContext.Provider, {
    ...
    mode: t.background,
    count: t.motion === "off" ? 0 : t.motion === "low" ? 10 : 30
