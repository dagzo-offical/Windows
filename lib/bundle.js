...
function SectionKernelWhat() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    uz: "Kernel nima?",
    en: "What is the kernel?"
  }), /*#__PURE__*/React.createElement(P, null, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "The ", /*#__PURE__*/React.createElement(Term, null, "kernel"), " is the core of the operating system \u2014 the one piece of software that has complete, unrestricted access to all hardware. While your browser and text editor live in the sandboxed ", /*#__PURE__*/React.createElement(Em, null, "user space"), ", the kernel lives in a completely separate, privileged area called ", /*#__PURE__*/React.createElement(Em, null, "kernel space"), ". It manages everything: memory, CPU time, files, network, and every piece of hardware connected to the machine.") : /*#__PURE__*/React.createElement(React.Fragment, null, "\xAB", /*#__PURE__*/React.createElement(Term, null, "Kernel"), "\xBB \u2014 operatsion tizimning asosi. Bu barcha hardware'ga to'liq, cheklovsiz kirishga ega bo'lgan yagona dastur. Brauzering va matn muharriringiz \xABsandbox\xBBlashtirilgan ", /*#__PURE__*/React.createElement(Em, null, "user space"), "'da yashasa, kernel butunlay boshqa, imtiyozli zonada \u2014 ", /*#__PURE__*/React.createElement(Em, null, "kernel space"), "'da yashaydi. U hamma narsani boshqaradi: xotira, CPU vaqti, fayllar, tarmoq va mashinaga ulangan har bir hardware.")), /*#__PURE__*/React.createElement(P, null, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "In Windows, the kernel lives inside a single file: ", /*#__PURE__*/React.createElement("code", null, "ntoskrnl.exe"), " (NT OS Kernel Executable). This ~10 MB file bootstraps every component of the OS when Windows starts. Without it, the machine cannot function at all.") : /*#__PURE__*/React.createElement(React.Fragment, null, "Windows'da kernel bitta faylda joylashgan: ", /*#__PURE__*/React.createElement("code", null, "ntoskrnl.exe"), " (NT OS Kernel Executable). Bu ~10 MB li fayl Windows ishga tushganda OT'ning barcha komponentlarini ishga tushiradi. U bo'lmasa \u2014 mashina umuman ishlay olmaydi.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(3, 1fr)",
      gap: 12,
    ...
    icon: "cpu",
    color: "var(--c-system)",
    uz: "CPU vaqtini boshqarish",
    en: "CPU scheduling",
    descUz: "Qaysi jarayon qachon protsessor vaqtini olishini kernel hal qiladi.",
    descEn: "The kernel decides which process gets CPU time and when."
  }, {
    icon: "database",
    color: "var(--accent)",
    uz: "Xotirani boshqarish",
    en: "Memory management",
    descUz: "Har bir jarayon o'z virtual manzil maydonini oladi. Kernel buni ta'minlaydi.",
    descEn: "Every process gets its own virtual address space. The kernel enforces this."
  }, {
    icon: "shield",
    color: "var(--c-auth)",
    uz: "Xavfsizlik siyosati",
    en: "Security policy",
    descUz: "Kernel har bir fayl, jarayon va qurilmaga kirish ruxsatini tekshiradi.",
    descEn: "The kernel checks every access permission for files, processes and devices."
  ...
  }, lang === "en" ? c.en : c.uz), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12.5,
      color: "var(--text-1)",
      lineHeight: 1.5
    }
  }, lang === "en" ? c.descEn : c.descUz)))), /*#__PURE__*/React.createElement(Callout, {
    color: "var(--accent)",
    icon: "info",
    titleUz: "ntoskrnl.exe \u2014 asosiy fayl",
    titleEn: "ntoskrnl.exe \u2014 the central file"
  }, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "You can find it at ", /*#__PURE__*/React.createElement("code", null, "C:\\Windows\\System32\\ntoskrnl.exe"), ". It is signed by Microsoft and any modification means Windows refuses to boot. This file contains both the ", /*#__PURE__*/React.createElement("strong", null, "Microkernel"), " and the ", /*#__PURE__*/React.createElement("strong", null, "Executive"), " \u2014 two separate layers packed into one binary.") : /*#__PURE__*/React.createElement(React.Fragment, null, "Uni ", /*#__PURE__*/React.createElement("code", null, "C:\\Windows\\System32\\ntoskrnl.exe"), " da topasiz. U Microsoft tomonidan imzolangan va har qanday o'zgartirishda Windows yuklashdan bosh tortadi. Bu fayl ", /*#__PURE__*/React.createElement("strong", null, "Microkernel"), " va ", /*#__PURE__*/React.createElement("strong", null, "Executive"), " ni \u2014 ikkita alohida qatlamni bitta faylda \u2014 o'z ichiga oladi.")));
}
function SectionKernelInside() {
  ...
  }), /*#__PURE__*/React.createElement(P, null, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "Despite being one file, ", /*#__PURE__*/React.createElement("code", null, "ntoskrnl.exe"), " contains two conceptually separate parts: the ", /*#__PURE__*/React.createElement(Term, null, "Microkernel"), " (the low-level engine) and the ", /*#__PURE__*/React.createElement(Term, null, "Executive"), " (the high-level policy layer). There's also one separate but closely related component: the ", /*#__PURE__*/React.createElement(Term, null, "HAL"), ".") : /*#__PURE__*/React.createElement(React.Fragment, null, "Bitta fayl bo'lishiga qaramay, ", /*#__PURE__*/React.createElement("code", null, "ntoskrnl.exe"), " ikki kontseptual alohida qismni o'z ichiga oladi: ", /*#__PURE__*/React.createElement(Term, null, "Microkernel"), " (past darajali dvigatel) va ", /*#__PURE__*/React.createElement(Term, null, "Executive"), " (yuqori darajali siyosat qatlami). Shuningdek, alohida lekin chambarchas bog'liq komponent ham bor: ", /*#__PURE__*/React.createElement(Term, null, "HAL"), ".")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 24,
      display: "flex",
      flexDirection: "column",
  ...
  }, "Microkernel")), /*#__PURE__*/React.createElement(P, null, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "The ", /*#__PURE__*/React.createElement(Term, null, "Microkernel"), " is the innermost engine. It handles three things only: ", /*#__PURE__*/React.createElement(Em, null, "thread scheduling"), " (deciding which thread runs next on which CPU), ", /*#__PURE__*/React.createElement(Em, null, "interrupt handling"), " (reacting to hardware signals like keyboard presses), and ", /*#__PURE__*/React.createElement(Em, null, "CPU synchronization"), " (keeping multiple cores in sync). It intentionally stays minimal \u2014 the fewer lines of code here, the smaller the attack surface.") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Term, null, "Microkernel"), " \u2014 eng ichki dvigatel. U faqat uchta ishni bajaradi: ", /*#__PURE__*/React.createElement(Em, null, "thread'larni rejalashtirish"), " (qaysi thread qaysi CPU'da keyingi o'tadi), ", /*#__PURE__*/React.createElement(Em, null, "uzilishlarni boshqarish"), " (klaviatura bosimi kabi hardware signallariga javob berish) va ", /*#__PURE__*/React.createElement(Em, null, "CPU sinxronizatsiyasi"), " (bir nechta yadrolarni sinxronlash). U ataylab minimal qoladi \u2014 bu yerda kod qanchalik kam bo'lsa, hujum yuzasi shunchalik kichik."))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "20px 24px",
      background: "rgba(0,255,156,0.04)",
      border: "1px solid var(--accent-border)",
  ...
  }, "Executive")), /*#__PURE__*/React.createElement(P, null, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "The ", /*#__PURE__*/React.createElement(Term, null, "Executive"), " sits above the microkernel and implements all the high-level ", /*#__PURE__*/React.createElement(Em, null, "policies"), ": what a process is, how memory is managed, how files work, and who can access what. It is split into managers:") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Term, null, "Executive"), " mikrokernelning ustida turadi va barcha yuqori darajali ", /*#__PURE__*/React.createElement(Em, null, "siyosatlarni"), " amalga oshiradi: jarayon nima, xotira qanday boshqariladi, fayllar qanday ishlaydi va kim nimaga kirish huquqiga ega. U menejerlarga bo'linadi:")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(2, 1fr)",
      gap: 8,
  ...
  }, (lang === "en" ? [["Process Manager", "Creates and destroys processes and threads"], ["Memory Manager", "Manages virtual memory and page files"], ["I/O Manager", "Routes requests to the right driver"], ["Object Manager", "Tracks every kernel object (files, handles, tokens)"], ["Security Reference Monitor", "Enforces access control (ACLs)"], ["Cache Manager", "Caches file data in RAM for speed"]] : [["Jarayon menejeri", "Jarayonlar va thread'larni yaratib, yo'q qiladi"], ["Xotira menejeri", "Virtual xotira va page fayllarini boshqaradi"], ["I/O menejeri", "So'rovlarni to'g'ri drayverga yo'naltiradi"], ["Ob'ekt menejeri", "Har bir kernel ob'ektini kuzatadi (fayllar, handle, token)"], ["Xavfsizlik monitord", "Kirish nazoratini ta'minlaydi (ACL)"], ["Kesh menejeri", "Tezlik uchun fayl ma'lumotlarini RAM'da saqlaydi"]]).map(([name, desc], i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      padding: "10px 14px",
      background: "var(--bg-2)",
  ...
  }, "HAL \u2014 Hardware Abstraction Layer")), /*#__PURE__*/React.createElement(P, null, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "The ", /*#__PURE__*/React.createElement(Term, null, "HAL"), " (", /*#__PURE__*/React.createElement("code", null, "hal.dll"), ") is a thin layer between the kernel and the actual hardware. Without it, Windows would need different code for every motherboard chipset. HAL provides a ", /*#__PURE__*/React.createElement(Em, null, "standard interface"), ": the kernel asks \xABwrite to this memory address\xBB and HAL translates it to the right instruction for the actual hardware installed. This is why the same ", /*#__PURE__*/React.createElement("code", null, "ntoskrnl.exe"), " runs on thousands of different PC models.") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Term, null, "HAL"), " (", /*#__PURE__*/React.createElement("code", null, "hal.dll"), ") \u2014 kernel va haqiqiy hardware o'rtasidagi yupqa qatlam. U bo'lmasa, Windows har bir ona plata chipset uchun alohida kod talab qilardi. HAL ", /*#__PURE__*/React.createElement(Em, null, "standart interfeys"), " ta'minlaydi: kernel \xABbu xotira manziliga yoz\xBB deb so'raydi, HAL esa buni o'rnatilgan haqiqiy hardware uchun to'g'ri buyruqqa tarjima qiladi. Shuning uchun bir xil ", /*#__PURE__*/React.createElement("code", null, "ntoskrnl.exe"), " minglab turli PC modellarida ishlaydi.")))));
}
function SectionKernelDrivers() {
  ...
  }), /*#__PURE__*/React.createElement(P, null, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "A ", /*#__PURE__*/React.createElement(Term, null, "driver"), " is a special program that tells the OS how to talk to a specific piece of hardware. Unlike regular apps, drivers run entirely in ", /*#__PURE__*/React.createElement(Em, null, "kernel mode (ring 0)"), " \u2014 the same privilege level as the kernel itself. This means a buggy or malicious driver can take down the entire system, which is why Windows requires drivers to be digitally signed.") : /*#__PURE__*/React.createElement(React.Fragment, null, "\xAB", /*#__PURE__*/React.createElement(Term, null, "Drayver"), "\xBB \u2014 OS'ga ma'lum bir hardware bilan qanday gaplashishni aytadigan maxsus dastur. Oddiy ilovalardan farqli o'laroq, drayverlar to'liq ", /*#__PURE__*/React.createElement(Em, null, "kernel mode (ring 0)"), "'da \u2014 kernelning o'zi bilan bir xil imtiyoz darajasida \u2014 ishlaydi. Bu degani, noto'g'ri yoki zararli drayver butun tizimni yiqitishi mumkin. Shuning uchun Windows drayverlardan raqamli imzo talab qiladi.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, (lang === "en" ? ["Certificate issued by Microsoft", "Signature verified at boot time", "Tampering detected → boot blocked", "Extension: .sys"] : ["Microsoft tomonidan sertifikat berilgan", "Imzo boot vaqtida tekshiriladi", "O'zgartirilsa → boot bloklanadi", "Kengaytma: .sys"]).map((t, i) => /*#__PURE__*/React.createElement("li", {
    key: i
  }, t)))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "18px 20px",
  ...
  }, lang === "en" ? "Unsigned driver" : "Imzolanmagan drayver"), /*#__PURE__*/React.createElement("ul", {
    style: {
      margin: 0,
      paddingLeft: 18,
      fontSize: 13,
  ...
  }, (lang === "en" ? ["No certificate — blocked by default", "Windows shows a warning or refuses load", "Common in BYOVD attacks", "Red flag in incident response"] : ["Sertifikat yo'q — odatda bloklanadi", "Windows ogohlantirish ko'rsatadi yoki yuklamaydi", "BYOVD hujumlarida keng tarqalgan", "Hodisalarga javob berishda qizil bayroq"]).map((t, i) => /*#__PURE__*/React.createElement("li", {
    key: i
  }, t))))), /*#__PURE__*/React.createElement(Callout, {
    color: "var(--c-attack)",
    icon: "warning",
    titleUz: "BYOVD hujumi",
    titleEn: "BYOVD attack"
  }, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", null, "BYOVD (Bring Your Own Vulnerable Driver)"), " is a technique where an attacker uses a ", /*#__PURE__*/React.createElement("em", null, "legitimate, signed but vulnerable"), " driver to gain ring 0 access. Because the driver is signed, Windows trusts it \u2014 but the attacker exploits a bug inside it to run their own code in the kernel. The defence: regularly check for vulnerable drivers with tools like ", /*#__PURE__*/React.createElement("code", null, "loldrivers.io"), ".") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", null, "BYOVD (Bring Your Own Vulnerable Driver)"), " \u2014 hujumchi ", /*#__PURE__*/React.createElement("em", null, "qonuniy, imzolangan, lekin zaif"), " drayverdan ring 0 kirishini olish uchun foydalanadi. Drayver imzolanganligi sababli Windows unga ishonadi \u2014 ammo hujumchi undagi xatolikni ekspluatatsiya qilib, kernelda o'z kodini ishga tushiradi. Himoya: ", /*#__PURE__*/React.createElement("code", null, "loldrivers.io"), " kabi vositalar bilan zaif drayverlarni muntazam tekshiring.")));
}
...
function SectionRings() {
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }), /*#__PURE__*/React.createElement(P, null, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "Modern processors don't just execute code \u2014 they enforce ", /*#__PURE__*/React.createElement(Term, null, "privilege levels"), ". The x86/x64 CPU architecture defines 4 rings (0 through 3), where ring 0 is the most privileged and ring 3 is the least. Windows only uses two: ", /*#__PURE__*/React.createElement(Em, null, "ring 0 (kernel mode)"), " and ", /*#__PURE__*/React.createElement(Em, null, "ring 3 (user mode)"), ". Rings 1 and 2 were intended for device drivers in the original design but were never used in practice.") : /*#__PURE__*/React.createElement(React.Fragment, null, "Zamonaviy protsessorlar faqat kod bajarmasdan, ", /*#__PURE__*/React.createElement(Term, null, "imtiyoz darajalarini"), " ham ta'minlaydi. x86/x64 CPU arxitekturasi 4 ta halqani (0 dan 3 gacha) belgilaydi: ring 0 \u2014 eng imtiyozli, ring 3 \u2014 eng kam imtiyozli. Windows faqat ikkitasidan foydalanadi: ", /*#__PURE__*/React.createElement(Em, null, "ring 0 (kernel mode)"), " va ", /*#__PURE__*/React.createElement(Em, null, "ring 3 (user mode)"), ". Ring 1 va 2 dastlabki dizaynda qurilma drayverlari uchun mo'ljallangan, lekin amalda hech qachon ishlatilmagan.")), /*#__PURE__*/React.createElement("div", {
    style: {
      margin: "28px auto",
      maxWidth: 380,
      position: "relative",
    ...
    style: {
      ...
      inset: 0,
      borderRadius: "50%",
      border: "2px solid rgba(255,145,69,0.4)",
  ...
  }, "ring 3 \xB7 User mode")), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 40,
      borderRadius: "50%",
  ...
  }, "ring 1 & 2 \xB7 unused")), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 88,
      borderRadius: "50%",
      border: "2px solid rgba(77,139,255,0.6)",
      background: "rgba(77,139,255,0.08)",
      display: "flex",
      alignItems: "center",
      justifyContent: "center"
  ...
  }, "ring 0"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      fontWeight: 700,
      color: "var(--c-system)",
  ...
  }, "ntoskrnl.exe"))), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      bottom: 18,
      left: "50%",
  ...
  }, "Chrome, Notepad, cmd.exe"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "1fr 1fr",
      gap: 14
  ...
  }, "RING 3 \xB7 USER MODE"), /*#__PURE__*/React.createElement("ul", {
    style: {
      margin: 0,
      paddingLeft: 18,
      fontSize: 13,
  ...
  }, (lang === "en" ? ["Cannot access hardware directly", "Cannot read another process's memory", "Cannot run privileged CPU instructions", "App crash = only that app dies", "Examples: Chrome, Notepad, Python scripts"] : ["Hardware'ga to'g'ridan-to'g'ri kira olmaydi", "Boshqa jarayonning xotirasini o'qiy olmaydi", "Imtiyozli CPU buyruqlarini bajara olmaydi", "Ilova xatosi = faqat o'sha ilova o'ladi", "Misollar: Chrome, Notepad, Python skriptlar"]).map((t, i) => /*#__PURE__*/React.createElement("li", {
    key: i
  }, t)))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "16px 20px",
  ...
  }, "RING 0 \xB7 KERNEL MODE"), /*#__PURE__*/React.createElement("ul", {
    style: {
      margin: 0,
      paddingLeft: 18,
      fontSize: 13,
  ...
  }, (lang === "en" ? ["Full access to all hardware", "Can read/write any memory address", "All CPU instructions available", "Crash here = BSOD, entire machine halts", "Examples: ntoskrnl.exe, drivers (.sys files)"] : ["Barcha hardware'ga to'liq kirish", "Istalgan xotira manziliga o'qish/yozish", "Barcha CPU buyruqlari mavjud", "Bu yerda xato = BSOD, butun mashina to'xtaydi", "Misollar: ntoskrnl.exe, drayverlar (.sys fayllar)"]).map((t, i) => /*#__PURE__*/React.createElement("li", {
    key: i
  }, t))))), /*#__PURE__*/React.createElement(Callout, {
    color: "var(--c-warn)",
    icon: "warning",
  ...
  }, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "Imagine if every app had full hardware access. A single buggy Chrome tab could corrupt RAM and crash everything. The ring boundary ensures that no matter how broken or malicious an app is, it ", /*#__PURE__*/React.createElement(Em, null, "cannot"), " directly harm the kernel or other processes. The kernel stays in control \u2014 and that's the entire premise of OS security.") : /*#__PURE__*/React.createElement(React.Fragment, null, "Tasavvur qiling, har bir ilova to'liq hardware kirishiga ega bo'lsa. Bitta noto'g'ri Chrome yorlig'i RAM'ni buzib, hamma narsani yiqitishi mumkin edi. Halqa chegarasi shunday ta'minlaydiki, ilova qanchalik buzilgan yoki zararli bo'lmasin, u kernelga yoki boshqa jarayonlarga to'g'ridan-to'g'ri zarar yetkazolmaydi. Kernel nazoratni qo'lida ushlab turadi \u2014 bu OT xavfsizligining asosiy printsipi.")));
}
function SectionSyscallBrief() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    num: "03",
    uz: "Chegarani qanday kesib o'tish mumkin?",
    en: "How do you legally cross the boundary?"
  }), /*#__PURE__*/React.createElement(P, null, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "A user-mode app can never just jump into kernel mode directly \u2014 the CPU won't allow it. The ", /*#__PURE__*/React.createElement(Em, null, "only"), " legal way to request a privileged service is through a ", /*#__PURE__*/React.createElement(Term, null, "system call"), " (syscall). This is a special CPU instruction that: saves the user-mode context, switches the CPU to ring 0, runs the requested kernel function, then returns the CPU back to ring 3.") : /*#__PURE__*/React.createElement(React.Fragment, null, "User mode'dagi ilova kernel mode'ga to'g'ridan-to'g'ri sakray olmaydi \u2014 protsessor buni ruxsat bermaydi. Imtiyozli xizmat talab qilishning ", /*#__PURE__*/React.createElement(Em, null, "yagona"), " qonuniy yo'li \u2014 ", /*#__PURE__*/React.createElement(Term, null, "tizim chaqiruvi"), " (syscall). Bu maxsus CPU buyrug'i: user mode kontekstini saqlaydi, CPU'ni ring 0 ga o'tkazadi, so'ralgan kernel funksiyasini bajaradi va CPU'ni ring 3 ga qaytaradi.")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20,
      padding: "20px 24px",
      background: "var(--bg-2)",
  ...
  }, "// ", lang === "en" ? "SIMPLIFIED CALL PATH" : "SODDALASHTIRILGAN CHAQIRUV YO'LI"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
    ...
    label: "Driver / Hardware",
    color: "var(--c-auth)"
  }].map((s, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    style: {
      fontFamily: s.label.includes("→") ? "var(--font-body)" : "var(--font-mono)",
      color: s.color,
      fontWeight: s.label.includes("→") ? 400 : 600
    }
  ...
  }, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "Everything to the left of \xABsyscall\xBB is in ring 3. Everything to the right is in ring 0. The syscall instruction is the only legal crossing point \u2014 this is the fundamental design of every modern OS.") : /*#__PURE__*/React.createElement(React.Fragment, null, "\xABsyscall\xBBdan chap tomondagi hamma narsa ring 3'da. O'ng tomondagi hamma narsa ring 0'da. Syscall buyrug'i \u2014 yagona qonuniy kesishish nuqtasi. Bu har bir zamonaviy OT'ning asosiy dizayni."))), /*#__PURE__*/React.createElement(Callout, {
    color: "var(--c-attack)",
    icon: "skull",
    titleUz: "Xavfsizlik nuqtai nazaridan",
    titleEn: "Security angle"
  }, lang === "en" ? /*#__PURE__*/React.createElement(React.Fragment, null, "Security tools (EDRs, antivirus) place ", /*#__PURE__*/React.createElement(Em, null, "hooks"), " inside ", /*#__PURE__*/React.createElement("code", null, "ntdll.dll"), " to monitor every syscall before it enters the kernel. Advanced malware bypasses this by calling the ", /*#__PURE__*/React.createElement("code", null, "syscall"), " instruction ", /*#__PURE__*/React.createElement(Em, null, "directly"), " \u2014 skipping the hooked ntdll entirely. This technique is called ", /*#__PURE__*/React.createElement("strong", null, "direct syscalls"), " and you'll study it in depth in the Windows API lesson.") : /*#__PURE__*/React.createElement(React.Fragment, null, "Xavfsizlik tizimlari (EDR, antivirus) har bir syscallni kernelga kirmasdan oldin kuzatish uchun ", /*#__PURE__*/React.createElement("code", null, "ntdll.dll"), " ichiga ", /*#__PURE__*/React.createElement(Em, null, "hook"), " joylashtiradi. Rivojlangan malware buni chetlab o'tadi: ", /*#__PURE__*/React.createElement("code", null, "syscall"), " buyrug'ini ", /*#__PURE__*/React.createElement(Em, null, "to'g'ridan-to'g'ri"), " chaqiradi \u2014 ushlangan ntdll'ni butunlay o'tkazib yuboradi. Bu texnika ", /*#__PURE__*/React.createElement("strong", null, "to'g'ridan-to'g'ri syscall"), " deyiladi va uni Windows API darsida chuqur o'rganasiz.")));
}
