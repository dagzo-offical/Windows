...
function SectionFAT32() {
  ...
  }, h)))), /*#__PURE__*/React.createElement("tbody", null, [["FAT entry size", "12 bits", "16 bits", "28 bits (in 32-bit field)"], ["Max cluster count", "2¹² − 12 = 4,084", "2¹⁶ − 12 = 65,524", "2²⁸ − 11 = 268,435,445"], ["Max volume — 512 B clusters", "4,084 × 512 B = 2 MB", "65,524 × 512 B = 32 MB", "268,435,445 × 512 B = 128 GB"], ["Max volume — 4 KB clusters", "4,084 × 4 KB = 16 MB", "65,524 × 4 KB = 256 MB", "268,435,445 × 4 KB = 1,024 GB (1 TB)"], ["Max volume — 32 KB clusters", "4,084 × 32 KB = 128 MB", "65,524 × 32 KB = 2,048 MB (2 GB)", "268,435,445 × 32 KB = 8,192 GB (8 TB)"], ["Max volume — 64 KB clusters", "4,084 × 64 KB = 256 MB", "65,524 × 64 KB = 4,096 MB (4 GB)", "268,435,445 × 64 KB = 16,384 GB (16 TB)"], ["Max file size", "Same as volume", "Same as volume", "2³² − 1 bytes = 4,294,967,295 B = 4 GB − 1 byte"], ["Windows format.exe limit", "—", "—", "32 GB (arbitrary policy, not spec)"], ["Root directory", "Fixed, 224 entries", "Fixed, 512 entries", "Dynamic (in data region, no limit)"], ["Year introduced", "1977", "1984", "1996"], ["Typical use", "Floppy disks", "Old USB drives", "Modern USB, SD, ESP"]].map((r, i) => /*#__PURE__*/React.createElement("tr", {
    key: i,
    style: {
      borderBottom: "1px solid rgba(255,255,255,0.04)",
      background: i % 2 === 0 ? "transparent" : "rgba(255,255,255,0.015)"
...
Get-Volume -DriveLetter D | Select-Object FileSystem, Size, SizeRemaining`))) : /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement(H2, {
  ...
  }, h)))), /*#__PURE__*/React.createElement("tbody", null, [["FAT yozuv hajmi", "12 bit", "16 bit", "28 bit (32-bitli maydon)"], ["Maks klaster soni", "2¹² − 12 = 4,084", "2¹⁶ − 12 = 65,524", "2²⁸ − 11 = 268,435,445"], ["Maks hajm — 512 B klaster", "4,084 × 512 B = 2 MB", "65,524 × 512 B = 32 MB", "268,435,445 × 512 B = 128 GB"], ["Maks hajm — 4 KB klaster", "4,084 × 4 KB = 16 MB", "65,524 × 4 KB = 256 MB", "268,435,445 × 4 KB = 1,024 GB (1 TB)"], ["Maks hajm — 32 KB klaster", "4,084 × 32 KB = 128 MB", "65,524 × 32 KB = 2,048 MB (2 GB)", "268,435,445 × 32 KB = 8,192 GB (8 TB)"], ["Maks hajm — 64 KB klaster", "4,084 × 64 KB = 256 MB", "65,524 × 64 KB = 4,096 MB (4 GB)", "268,435,445 × 64 KB = 16,384 GB (16 TB)"], ["Maks fayl hajmi", "Hajm kabi", "Hajm kabi", "2³² − 1 bayt = 4,294,967,295 B = 4 GB − 1 bayt"], ["Windows format.exe chegarasi", "—", "—", "32 GB (ixtiyoriy siyosat, spesifikatsiya emas)"], ["Ildiz katalog", "224 yozuv (qat'iy)", "512 yozuv (qat'iy)", "Dinamik (chegarasiz)"], ["Kiritilgan", "1977", "1984", "1996"], ["Odatdagi foydalanish", "Disketalar", "Eski USB", "Zamonaviy USB, SD, ESP"]].map((r, i) => /*#__PURE__*/React.createElement("tr", {
    key: i,
    style: {
      borderBottom: "1px solid rgba(255,255,255,0.04)",
      background: i % 2 === 0 ? "transparent" : "rgba(255,255,255,0.015)"
